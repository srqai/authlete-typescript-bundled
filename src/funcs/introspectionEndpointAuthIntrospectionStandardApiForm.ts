...
import { AuthIntrospectionStandardApiFormServerList } from "../models/operations/authintrospectionstandardapiform.js";
...
export function introspectionEndpointAuthIntrospectionStandardApiForm(
  ...
  Result<
    ...
    | errors.AuthIntrospectionStandardApiFormBadRequestError
    | errors.AuthIntrospectionStandardApiFormUnauthorizedError
    | errors.AuthIntrospectionStandardApiFormForbiddenError
    | errors.AuthIntrospectionStandardApiFormInternalServerError
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(AuthIntrospectionStandardApiFormServerList[0], {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.AuthIntrospectionStandardApiFormBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.AuthIntrospectionStandardApiFormUnauthorizedError$inboundSchema,
    ),
    M.jsonErr(
      403,
      errors.AuthIntrospectionStandardApiFormForbiddenError$inboundSchema,
    ),
    M.jsonErr(
      500,
      errors.AuthIntrospectionStandardApiFormInternalServerError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
