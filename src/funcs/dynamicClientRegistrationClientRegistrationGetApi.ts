...
import { ClientRegistrationGetApiServerList } from "../models/operations/clientregistrationgetapi.js";
...
export function dynamicClientRegistrationClientRegistrationGetApi(
  ...
  Result<
    ...
    | errors.ClientRegistrationGetApiBadRequestError
    | errors.ClientRegistrationGetApiUnauthorizedError
    | errors.ClientRegistrationGetApiForbiddenError
    | errors.ClientRegistrationGetApiInternalServerError
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(ClientRegistrationGetApiServerList[0], {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.ClientRegistrationGetApiBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ClientRegistrationGetApiUnauthorizedError$inboundSchema,
    ),
    M.jsonErr(403, errors.ClientRegistrationGetApiForbiddenError$inboundSchema),
    M.jsonErr(
      500,
      errors.ClientRegistrationGetApiInternalServerError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
