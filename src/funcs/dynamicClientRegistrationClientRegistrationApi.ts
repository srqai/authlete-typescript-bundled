...
import { ClientRegistrationApiServerList } from "../models/operations/clientregistrationapi.js";
...
export function dynamicClientRegistrationClientRegistrationApi(
  ...
  Result<
    ...
    | errors.ClientRegistrationApiBadRequestError
    | errors.ClientRegistrationApiUnauthorizedError
    | errors.ClientRegistrationApiForbiddenError
    | errors.ClientRegistrationApiInternalServerError
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(ClientRegistrationApiServerList[0], {
  ...
  >(
    ...
    M.jsonErr(400, errors.ClientRegistrationApiBadRequestError$inboundSchema),
    M.jsonErr(401, errors.ClientRegistrationApiUnauthorizedError$inboundSchema),
    M.jsonErr(403, errors.ClientRegistrationApiForbiddenError$inboundSchema),
    M.jsonErr(
      500,
      errors.ClientRegistrationApiInternalServerError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
