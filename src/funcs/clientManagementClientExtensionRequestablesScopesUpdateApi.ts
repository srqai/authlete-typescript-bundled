...
import { ClientExtensionRequestablesScopesUpdateApiServerList } from "../models/operations/clientextensionrequestablesscopesupdateapi.js";
...
export function clientManagementClientExtensionRequestablesScopesUpdateApi(
  ...
  Result<
    ...
    | errors.ClientExtensionRequestablesScopesUpdateApiBadRequestError
    | errors.ClientExtensionRequestablesScopesUpdateApiUnauthorizedError
    | errors.ClientExtensionRequestablesScopesUpdateApiForbiddenError
    | errors.ClientExtensionRequestablesScopesUpdateApiInternalServerError
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(ClientExtensionRequestablesScopesUpdateApiServerList[0], {
