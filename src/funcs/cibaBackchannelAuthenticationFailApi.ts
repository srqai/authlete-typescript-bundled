...
import { BackchannelAuthenticationFailApiServerList } from "../models/operations/backchannelauthenticationfailapi.js";
...
export function cibaBackchannelAuthenticationFailApi(
  ...
  Result<
    ...
    | errors.BackchannelAuthenticationFailApiBadRequestError
    | errors.BackchannelAuthenticationFailApiUnauthorizedError
    | errors.BackchannelAuthenticationFailApiForbiddenError
    | errors.BackchannelAuthenticationFailApiInternalServerError
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(BackchannelAuthenticationFailApiServerList[0], {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.BackchannelAuthenticationFailApiBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.BackchannelAuthenticationFailApiUnauthorizedError$inboundSchema,
    ),
    M.jsonErr(
      403,
      errors.BackchannelAuthenticationFailApiForbiddenError$inboundSchema,
    ),
    M.jsonErr(
      500,
      errors.BackchannelAuthenticationFailApiInternalServerError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
