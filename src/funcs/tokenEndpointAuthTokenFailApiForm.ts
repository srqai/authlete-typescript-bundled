...
import { AuthTokenFailApiFormServerList } from "../models/operations/authtokenfailapiform.js";
...
export function tokenEndpointAuthTokenFailApiForm(
  ...
  Result<
    ...
    | errors.AuthTokenFailApiFormBadRequestError
    | errors.AuthTokenFailApiFormUnauthorizedError
    | errors.AuthTokenFailApiFormForbiddenError
    | errors.AuthTokenFailApiFormInternalServerError
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(AuthTokenFailApiFormServerList[0], {
  ...
  >(
    ...
    M.jsonErr(400, errors.AuthTokenFailApiFormBadRequestError$inboundSchema),
    M.jsonErr(401, errors.AuthTokenFailApiFormUnauthorizedError$inboundSchema),
    M.jsonErr(403, errors.AuthTokenFailApiFormForbiddenError$inboundSchema),
    M.jsonErr(
      500,
      errors.AuthTokenFailApiFormInternalServerError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
