...
import { AuthAuthorizationIssueApiFormServerList } from "../models/operations/authauthorizationissueapiform.js";
...
export function authorizationEndpointAuthAuthorizationIssueApiForm(
  ...
  Result<
    ...
    | errors.AuthAuthorizationIssueApiFormBadRequestError
    | errors.AuthAuthorizationIssueApiFormUnauthorizedError
    | errors.AuthAuthorizationIssueApiFormForbiddenError
    | errors.AuthAuthorizationIssueApiFormInternalServerError
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(AuthAuthorizationIssueApiFormServerList[0], {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.AuthAuthorizationIssueApiFormBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.AuthAuthorizationIssueApiFormUnauthorizedError$inboundSchema,
    ),
    M.jsonErr(
      403,
      errors.AuthAuthorizationIssueApiFormForbiddenError$inboundSchema,
    ),
    M.jsonErr(
      500,
      errors.AuthAuthorizationIssueApiFormInternalServerError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
