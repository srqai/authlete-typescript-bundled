...
import { AuthTokenFailApiServerList } from "../models/operations/authtokenfailapi.js";
...
export function tokenEndpointAuthTokenFailApi(
  ...
  Result<
    ...
    | errors.AuthTokenFailApiBadRequestError
    | errors.AuthTokenFailApiUnauthorizedError
    | errors.AuthTokenFailApiForbiddenError
    | errors.AuthTokenFailApiInternalServerError
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(AuthTokenFailApiServerList[0], { charEncoding: "percent" })();
  ...
  >(
    ...
    M.jsonErr(400, errors.AuthTokenFailApiBadRequestError$inboundSchema),
    M.jsonErr(401, errors.AuthTokenFailApiUnauthorizedError$inboundSchema),
    M.jsonErr(403, errors.AuthTokenFailApiForbiddenError$inboundSchema),
    M.jsonErr(500, errors.AuthTokenFailApiInternalServerError$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
