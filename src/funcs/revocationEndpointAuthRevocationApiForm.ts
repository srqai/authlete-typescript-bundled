...
import { AuthRevocationApiFormServerList } from "../models/operations/authrevocationapiform.js";
...
export function revocationEndpointAuthRevocationApiForm(
  ...
  Result<
    ...
    | errors.AuthRevocationApiFormBadRequestError
    | errors.AuthRevocationApiFormUnauthorizedError
    | errors.AuthRevocationApiFormForbiddenError
    | errors.AuthRevocationApiFormInternalServerError
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(AuthRevocationApiFormServerList[0], {
  ...
  >(
    ...
    M.jsonErr(400, errors.AuthRevocationApiFormBadRequestError$inboundSchema),
    M.jsonErr(401, errors.AuthRevocationApiFormUnauthorizedError$inboundSchema),
    M.jsonErr(403, errors.AuthRevocationApiFormForbiddenError$inboundSchema),
    M.jsonErr(
      500,
      errors.AuthRevocationApiFormInternalServerError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
