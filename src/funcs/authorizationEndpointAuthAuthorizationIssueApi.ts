...
import { AuthAuthorizationIssueApiServerList } from "../models/operations/authauthorizationissueapi.js";
...
export function authorizationEndpointAuthAuthorizationIssueApi(
  ...
  Result<
    ...
    | errors.AuthAuthorizationIssueApiBadRequestError
    | errors.AuthAuthorizationIssueApiUnauthorizedError
    | errors.AuthAuthorizationIssueApiForbiddenError
    | errors.AuthAuthorizationIssueApiInternalServerError
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(AuthAuthorizationIssueApiServerList[0], {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.AuthAuthorizationIssueApiBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.AuthAuthorizationIssueApiUnauthorizedError$inboundSchema,
    ),
    M.jsonErr(
      403,
      errors.AuthAuthorizationIssueApiForbiddenError$inboundSchema,
    ),
    M.jsonErr(
      500,
      errors.AuthAuthorizationIssueApiInternalServerError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
