...
import { DeviceAuthorizationApiFormServerList } from "../models/operations/deviceauthorizationapiform.js";
...
export function deviceFlowDeviceAuthorizationApiForm(
  ...
  Result<
    ...
    | errors.DeviceAuthorizationApiFormBadRequestError
    | errors.DeviceAuthorizationApiFormUnauthorizedError
    | errors.DeviceAuthorizationApiFormForbiddenError
    | errors.DeviceAuthorizationApiFormInternalServerError
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(DeviceAuthorizationApiFormServerList[0], {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.DeviceAuthorizationApiFormBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.DeviceAuthorizationApiFormUnauthorizedError$inboundSchema,
    ),
    M.jsonErr(
      403,
      errors.DeviceAuthorizationApiFormForbiddenError$inboundSchema,
    ),
    M.jsonErr(
      500,
      errors.DeviceAuthorizationApiFormInternalServerError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
