...
import { ClientRegistrationUpdateApiServerList } from "../models/operations/clientregistrationupdateapi.js";
...
export function dynamicClientRegistrationClientRegistrationUpdateApi(
  ...
  Result<
    ...
    | errors.ClientRegistrationUpdateApiBadRequestError
    | errors.ClientRegistrationUpdateApiUnauthorizedError
    | errors.ClientRegistrationUpdateApiForbiddenError
    | errors.ClientRegistrationUpdateApiInternalServerError
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(ClientRegistrationUpdateApiServerList[0], {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.ClientRegistrationUpdateApiBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ClientRegistrationUpdateApiUnauthorizedError$inboundSchema,
    ),
    M.jsonErr(
      403,
      errors.ClientRegistrationUpdateApiForbiddenError$inboundSchema,
    ),
    M.jsonErr(
      500,
      errors.ClientRegistrationUpdateApiInternalServerError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
