...
import { AuthAuthorizationApiFormServerList } from "../models/operations/authauthorizationapiform.js";
...
export function authorizationEndpointAuthAuthorizationApiForm(
  ...
  Result<
    ...
    | errors.AuthAuthorizationApiFormBadRequestError
    | errors.AuthAuthorizationApiFormUnauthorizedError
    | errors.AuthAuthorizationApiFormForbiddenError
    | errors.AuthAuthorizationApiFormInternalServerError
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(AuthAuthorizationApiFormServerList[0], {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.AuthAuthorizationApiFormBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.AuthAuthorizationApiFormUnauthorizedError$inboundSchema,
    ),
    M.jsonErr(403, errors.AuthAuthorizationApiFormForbiddenError$inboundSchema),
    M.jsonErr(
      500,
      errors.AuthAuthorizationApiFormInternalServerError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
