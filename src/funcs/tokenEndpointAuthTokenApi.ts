...
import { AuthTokenApiServerList } from "../models/operations/authtokenapi.js";
...
export function tokenEndpointAuthTokenApi(
  ...
  Result<
    ...
    | errors.AuthTokenApiBadRequestError
    | errors.AuthTokenApiUnauthorizedError
    | errors.AuthTokenApiForbiddenError
    | errors.AuthTokenApiInternalServerError
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(AuthTokenApiServerList[0], { charEncoding: "percent" })();
  ...
  >(
    ...
    M.jsonErr(400, errors.AuthTokenApiBadRequestError$inboundSchema),
    M.jsonErr(401, errors.AuthTokenApiUnauthorizedError$inboundSchema),
    M.jsonErr(403, errors.AuthTokenApiForbiddenError$inboundSchema),
    M.jsonErr(500, errors.AuthTokenApiInternalServerError$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
