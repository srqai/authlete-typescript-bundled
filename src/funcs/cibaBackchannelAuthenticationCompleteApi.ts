...
import { BackchannelAuthenticationCompleteApiServerList } from "../models/operations/backchannelauthenticationcompleteapi.js";
...
export function cibaBackchannelAuthenticationCompleteApi(
  ...
  Result<
    ...
    | errors.BackchannelAuthenticationCompleteApiBadRequestError
    | errors.BackchannelAuthenticationCompleteApiUnauthorizedError
    | errors.BackchannelAuthenticationCompleteApiForbiddenError
    | errors.BackchannelAuthenticationCompleteApiInternalServerError
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(BackchannelAuthenticationCompleteApiServerList[0], {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.BackchannelAuthenticationCompleteApiBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors
    ...
    M.jsonErr(
      403,
      errors.BackchannelAuthenticationCompleteApiForbiddenError$inboundSchema,
    ),
    M.jsonErr(
      500,
      errors
