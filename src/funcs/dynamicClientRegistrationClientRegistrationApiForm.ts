...
import { ClientRegistrationApiFormServerList } from "../models/operations/clientregistrationapiform.js";
...
export function dynamicClientRegistrationClientRegistrationApiForm(
  ...
  Result<
    ...
    | errors.ClientRegistrationApiFormBadRequestError
    | errors.ClientRegistrationApiFormUnauthorizedError
    | errors.ClientRegistrationApiFormForbiddenError
    | errors.ClientRegistrationApiFormInternalServerError
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(ClientRegistrationApiFormServerList[0], {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.ClientRegistrationApiFormBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ClientRegistrationApiFormUnauthorizedError$inboundSchema,
    ),
    M.jsonErr(
      403,
      errors.ClientRegistrationApiFormForbiddenError$inboundSchema,
    ),
    M.jsonErr(
      500,
      errors.ClientRegistrationApiFormInternalServerError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
