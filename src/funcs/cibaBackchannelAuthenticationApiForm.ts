...
import { BackchannelAuthenticationApiFormServerList } from "../models/operations/backchannelauthenticationapiform.js";
...
export function cibaBackchannelAuthenticationApiForm(
  ...
  Result<
    ...
    | errors.BackchannelAuthenticationApiFormBadRequestError
    | errors.BackchannelAuthenticationApiFormUnauthorizedError
    | errors.BackchannelAuthenticationApiFormForbiddenError
    | errors.BackchannelAuthenticationApiFormInternalServerError
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(BackchannelAuthenticationApiFormServerList[0], {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.BackchannelAuthenticationApiFormBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.BackchannelAuthenticationApiFormUnauthorizedError$inboundSchema,
    ),
    M.jsonErr(
      403,
      errors.BackchannelAuthenticationApiFormForbiddenError$inboundSchema,
    ),
    M.jsonErr(
      500,
      errors.BackchannelAuthenticationApiFormInternalServerError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
