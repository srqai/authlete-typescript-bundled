...
import { AuthUserinfoIssueApiServerList } from "../models/operations/authuserinfoissueapi.js";
...
export function userInfoEndpointAuthUserinfoIssueApi(
  ...
  Result<
    ...
    | errors.AuthUserinfoIssueApiBadRequestError
    | errors.AuthUserinfoIssueApiUnauthorizedError
    | errors.AuthUserinfoIssueApiForbiddenError
    | errors.AuthUserinfoIssueApiInternalServerError
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(AuthUserinfoIssueApiServerList[0], {
  ...
  >(
    ...
    M.jsonErr(400, errors.AuthUserinfoIssueApiBadRequestError$inboundSchema),
    M.jsonErr(401, errors.AuthUserinfoIssueApiUnauthorizedError$inboundSchema),
    M.jsonErr(403, errors.AuthUserinfoIssueApiForbiddenError$inboundSchema),
    M.jsonErr(
      500,
      errors.AuthUserinfoIssueApiInternalServerError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
