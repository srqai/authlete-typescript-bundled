...
import { AuthIntrospectionApiServerList } from "../models/operations/authintrospectionapi.js";
...
export function introspectionEndpointAuthIntrospectionApi(
  ...
  Result<
    ...
    | errors.AuthIntrospectionApiBadRequestError
    | errors.AuthIntrospectionApiUnauthorizedError
    | errors.AuthIntrospectionApiForbiddenError
    | errors.AuthIntrospectionApiInternalServerError
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(AuthIntrospectionApiServerList[0], {
  ...
  >(
    ...
    M.jsonErr(400, errors.AuthIntrospectionApiBadRequestError$inboundSchema),
    M.jsonErr(401, errors.AuthIntrospectionApiUnauthorizedError$inboundSchema),
    M.jsonErr(403, errors.AuthIntrospectionApiForbiddenError$inboundSchema),
    M.jsonErr(
      500,
      errors.AuthIntrospectionApiInternalServerError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
