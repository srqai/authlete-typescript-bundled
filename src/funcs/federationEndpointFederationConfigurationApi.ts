...
import { FederationConfigurationApiServerList } from "../models/operations/federationconfigurationapi.js";
...
export function federationEndpointFederationConfigurationApi(
  ...
  Result<
    ...
    | errors.FederationConfigurationApiBadRequestError
    | errors.FederationConfigurationApiUnauthorizedError
    | errors.FederationConfigurationApiForbiddenError
    | errors.FederationConfigurationApiInternalServerError
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(FederationConfigurationApiServerList[0], {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.FederationConfigurationApiBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.FederationConfigurationApiUnauthorizedError$inboundSchema,
    ),
    M.jsonErr(
      403,
      errors.FederationConfigurationApiForbiddenError$inboundSchema,
    ),
    M.jsonErr(
      500,
      errors.FederationConfigurationApiInternalServerError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
