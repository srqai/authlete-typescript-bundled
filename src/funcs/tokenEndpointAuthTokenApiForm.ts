...
import { AuthTokenApiFormServerList } from "../models/operations/authtokenapiform.js";
...
export function tokenEndpointAuthTokenApiForm(
  ...
  Result<
    ...
    | errors.AuthTokenApiFormBadRequestError
    | errors.AuthTokenApiFormUnauthorizedError
    | errors.AuthTokenApiFormForbiddenError
    | errors.AuthTokenApiFormInternalServerError
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(AuthTokenApiFormServerList[0], { charEncoding: "percent" })();
  ...
  >(
    ...
    M.jsonErr(400, errors.AuthTokenApiFormBadRequestError$inboundSchema),
    M.jsonErr(401, errors.AuthTokenApiFormUnauthorizedError$inboundSchema),
    M.jsonErr(403, errors.AuthTokenApiFormForbiddenError$inboundSchema),
    M.jsonErr(500, errors.AuthTokenApiFormInternalServerError$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
