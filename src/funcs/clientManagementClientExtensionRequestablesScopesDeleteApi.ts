...
import { ClientExtensionRequestablesScopesDeleteApiServerList } from "../models/operations/clientextensionrequestablesscopesdeleteapi.js";
...
export function clientManagementClientExtensionRequestablesScopesDeleteApi(
  ...
  Result<
    void,
    | errors.ClientExtensionRequestablesScopesDeleteApiBadRequestError
    | errors.ClientExtensionRequestablesScopesDeleteApiUnauthorizedError
    | errors.ClientExtensionRequestablesScopesDeleteApiForbiddenError
    | errors.ClientExtensionRequestablesScopesDeleteApiInternalServerError
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(ClientExtensionRequestablesScopesDeleteApiServerList[0], {
