...
import { ClientRegistrationDeleteApiFormServerList } from "../models/operations/clientregistrationdeleteapiform.js";
...
export function dynamicClientRegistrationClientRegistrationDeleteApiForm(
  ...
  Result<
    ...
    | errors.ClientRegistrationDeleteApiFormBadRequestError
    | errors.ClientRegistrationDeleteApiFormUnauthorizedError
    | errors.ClientRegistrationDeleteApiFormForbiddenError
    | errors.ClientRegistrationDeleteApiFormInternalServerError
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(ClientRegistrationDeleteApiFormServerList[0], {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.ClientRegistrationDeleteApiFormBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ClientRegistrationDeleteApiFormUnauthorizedError$inboundSchema,
    ),
    M.jsonErr(
      403,
      errors.ClientRegistrationDeleteApiFormForbiddenError$inboundSchema,
    ),
    M.jsonErr(
      500,
      errors.ClientRegistrationDeleteApiFormInternalServerError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
