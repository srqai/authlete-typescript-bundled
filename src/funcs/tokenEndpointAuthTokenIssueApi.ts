...
import { AuthTokenIssueApiServerList } from "../models/operations/authtokenissueapi.js";
...
export function tokenEndpointAuthTokenIssueApi(
  ...
  Result<
    ...
    | errors.AuthTokenIssueApiBadRequestError
    | errors.AuthTokenIssueApiUnauthorizedError
    | errors.AuthTokenIssueApiForbiddenError
    | errors.AuthTokenIssueApiInternalServerError
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(AuthTokenIssueApiServerList[0], {
  ...
  >(
    ...
    M.jsonErr(400, errors.AuthTokenIssueApiBadRequestError$inboundSchema),
    M.jsonErr(401, errors.AuthTokenIssueApiUnauthorizedError$inboundSchema),
    M.jsonErr(403, errors.AuthTokenIssueApiForbiddenError$inboundSchema),
    M.jsonErr(500, errors.AuthTokenIssueApiInternalServerError$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
