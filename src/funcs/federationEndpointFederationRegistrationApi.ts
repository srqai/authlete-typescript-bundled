...
import { FederationRegistrationApiServerList } from "../models/operations/federationregistrationapi.js";
...
export function federationEndpointFederationRegistrationApi(
  ...
  Result<
    ...
    | errors.FederationRegistrationApiBadRequestError
    | errors.FederationRegistrationApiUnauthorizedError
    | errors.FederationRegistrationApiForbiddenError
    | errors.FederationRegistrationApiInternalServerError
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(FederationRegistrationApiServerList[0], {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.FederationRegistrationApiBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.FederationRegistrationApiUnauthorizedError$inboundSchema,
    ),
    M.jsonErr(
      403,
      errors.FederationRegistrationApiForbiddenError$inboundSchema,
    ),
    M.jsonErr(
      500,
      errors.FederationRegistrationApiInternalServerError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
