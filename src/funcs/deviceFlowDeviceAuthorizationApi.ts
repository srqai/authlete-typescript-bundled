...
import { DeviceAuthorizationApiServerList } from "../models/operations/deviceauthorizationapi.js";
...
export function deviceFlowDeviceAuthorizationApi(
  ...
  Result<
    ...
    | errors.DeviceAuthorizationApiBadRequestError
    | errors.DeviceAuthorizationApiUnauthorizedError
    | errors.DeviceAuthorizationApiForbiddenError
    | errors.DeviceAuthorizationApiInternalServerError
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(DeviceAuthorizationApiServerList[0], {
  ...
  >(
    ...
    M.jsonErr(400, errors.DeviceAuthorizationApiBadRequestError$inboundSchema),
    M.jsonErr(
      401,
      errors.DeviceAuthorizationApiUnauthorizedError$inboundSchema,
    ),
    M.jsonErr(403, errors.DeviceAuthorizationApiForbiddenError$inboundSchema),
    M.jsonErr(
      500,
      errors.DeviceAuthorizationApiInternalServerError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
