...
import { BackchannelAuthenticationIssueApiServerList } from "../models/operations/backchannelauthenticationissueapi.js";
...
export function cibaBackchannelAuthenticationIssueApi(
  ...
  Result<
    ...
    | errors.BackchannelAuthenticationIssueApiBadRequestError
    | errors.BackchannelAuthenticationIssueApiUnauthorizedError
    | errors.BackchannelAuthenticationIssueApiForbiddenError
    | errors.BackchannelAuthenticationIssueApiInternalServerError
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(BackchannelAuthenticationIssueApiServerList[0], {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.BackchannelAuthenticationIssueApiBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.BackchannelAuthenticationIssueApiUnauthorizedError$inboundSchema,
    ),
    M.jsonErr(
      403,
      errors.BackchannelAuthenticationIssueApiForbiddenError$inboundSchema,
    ),
    M.jsonErr(
      500,
      errors.BackchannelAuthenticationIssueApiInternalServerError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
