...
import { BackchannelAuthenticationApiServerList } from "../models/operations/backchannelauthenticationapi.js";
...
export function cibaBackchannelAuthenticationApi(
  ...
  Result<
    ...
    | errors.BackchannelAuthenticationApiBadRequestError
    | errors.BackchannelAuthenticationApiUnauthorizedError
    | errors.BackchannelAuthenticationApiForbiddenError
    | errors.BackchannelAuthenticationApiInternalServerError
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(BackchannelAuthenticationApiServerList[0], {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.BackchannelAuthenticationApiBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.BackchannelAuthenticationApiUnauthorizedError$inboundSchema,
    ),
    M.jsonErr(
      403,
      errors.BackchannelAuthenticationApiForbiddenError$inboundSchema,
    ),
    M.jsonErr(
      500,
      errors.BackchannelAuthenticationApiInternalServerError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
