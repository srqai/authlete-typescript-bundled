...
import { AuthIntrospectionApiFormServerList } from "../models/operations/authintrospectionapiform.js";
...
export function introspectionEndpointAuthIntrospectionApiForm(
  ...
  Result<
    ...
    | errors.AuthIntrospectionApiFormBadRequestError
    | errors.AuthIntrospectionApiFormUnauthorizedError
    | errors.AuthIntrospectionApiFormForbiddenError
    | errors.AuthIntrospectionApiFormInternalServerError
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(AuthIntrospectionApiFormServerList[0], {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.AuthIntrospectionApiFormBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.AuthIntrospectionApiFormUnauthorizedError$inboundSchema,
    ),
    M.jsonErr(403, errors.AuthIntrospectionApiFormForbiddenError$inboundSchema),
    M.jsonErr(
      500,
      errors.AuthIntrospectionApiFormInternalServerError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
