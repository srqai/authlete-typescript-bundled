...
import { DeviceVerificationApiFormServerList } from "../models/operations/deviceverificationapiform.js";
...
export function deviceFlowDeviceVerificationApiForm(
  ...
  Result<
    ...
    | errors.DeviceVerificationApiFormBadRequestError
    | errors.DeviceVerificationApiFormUnauthorizedError
    | errors.DeviceVerificationApiFormForbiddenError
    | errors.DeviceVerificationApiFormInternalServerError
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(DeviceVerificationApiFormServerList[0], {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.DeviceVerificationApiFormBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.DeviceVerificationApiFormUnauthorizedError$inboundSchema,
    ),
    M.jsonErr(
      403,
      errors.DeviceVerificationApiFormForbiddenError$inboundSchema,
    ),
    M.jsonErr(
      500,
      errors.DeviceVerificationApiFormInternalServerError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
