...
import { AuthTokenIssueApiFormServerList } from "../models/operations/authtokenissueapiform.js";
...
export function tokenEndpointAuthTokenIssueApiForm(
  ...
  Result<
    ...
    | errors.AuthTokenIssueApiFormBadRequestError
    | errors.AuthTokenIssueApiFormUnauthorizedError
    | errors.AuthTokenIssueApiFormForbiddenError
    | errors.AuthTokenIssueApiFormInternalServerError
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(AuthTokenIssueApiFormServerList[0], {
  ...
  >(
    ...
    M.jsonErr(400, errors.AuthTokenIssueApiFormBadRequestError$inboundSchema),
    M.jsonErr(401, errors.AuthTokenIssueApiFormUnauthorizedError$inboundSchema),
    M.jsonErr(403, errors.AuthTokenIssueApiFormForbiddenError$inboundSchema),
    M.jsonErr(
      500,
      errors.AuthTokenIssueApiFormInternalServerError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
