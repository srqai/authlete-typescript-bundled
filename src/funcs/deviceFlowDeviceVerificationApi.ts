...
import { DeviceVerificationApiServerList } from "../models/operations/deviceverificationapi.js";
...
export function deviceFlowDeviceVerificationApi(
  ...
  Result<
    ...
    | errors.DeviceVerificationApiBadRequestError
    | errors.DeviceVerificationApiUnauthorizedError
    | errors.DeviceVerificationApiForbiddenError
    | errors.DeviceVerificationApiInternalServerError
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(DeviceVerificationApiServerList[0], {
  ...
  >(
    ...
    M.jsonErr(400, errors.DeviceVerificationApiBadRequestError$inboundSchema),
    M.jsonErr(401, errors.DeviceVerificationApiUnauthorizedError$inboundSchema),
    M.jsonErr(403, errors.DeviceVerificationApiForbiddenError$inboundSchema),
    M.jsonErr(
      500,
      errors.DeviceVerificationApiInternalServerError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
