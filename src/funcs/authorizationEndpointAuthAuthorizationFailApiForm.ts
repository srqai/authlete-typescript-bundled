...
import { AuthAuthorizationFailApiFormServerList } from "../models/operations/authauthorizationfailapiform.js";
...
export function authorizationEndpointAuthAuthorizationFailApiForm(
  ...
  Result<
    ...
    | errors.AuthAuthorizationFailApiFormBadRequestError
    | errors.AuthAuthorizationFailApiFormUnauthorizedError
    | errors.AuthAuthorizationFailApiFormForbiddenError
    | errors.AuthAuthorizationFailApiFormInternalServerError
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(AuthAuthorizationFailApiFormServerList[0], {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.AuthAuthorizationFailApiFormBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.AuthAuthorizationFailApiFormUnauthorizedError$inboundSchema,
    ),
    M.jsonErr(
      403,
      errors.AuthAuthorizationFailApiFormForbiddenError$inboundSchema,
    ),
    M.jsonErr(
      500,
      errors.AuthAuthorizationFailApiFormInternalServerError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
