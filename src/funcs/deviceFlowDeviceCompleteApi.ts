...
import { DeviceCompleteApiServerList } from "../models/operations/devicecompleteapi.js";
...
export function deviceFlowDeviceCompleteApi(
  ...
  Result<
    ...
    | errors.DeviceCompleteApiBadRequestError
    | errors.DeviceCompleteApiUnauthorizedError
    | errors.DeviceCompleteApiForbiddenError
    | errors.DeviceCompleteApiInternalServerError
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(DeviceCompleteApiServerList[0], {
  ...
  >(
    ...
    M.jsonErr(400, errors.DeviceCompleteApiBadRequestError$inboundSchema),
    M.jsonErr(401, errors.DeviceCompleteApiUnauthorizedError$inboundSchema),
    M.jsonErr(403, errors.DeviceCompleteApiForbiddenError$inboundSchema),
    M.jsonErr(500, errors.DeviceCompleteApiInternalServerError$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
