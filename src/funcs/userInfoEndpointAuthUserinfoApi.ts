...
import { AuthUserinfoApiServerList } from "../models/operations/authuserinfoapi.js";
...
export function userInfoEndpointAuthUserinfoApi(
  ...
  Result<
    ...
    | errors.AuthUserinfoApiBadRequestError
    | errors.AuthUserinfoApiUnauthorizedError
    | errors.AuthUserinfoApiForbiddenError
    | errors.AuthUserinfoApiInternalServerError
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(AuthUserinfoApiServerList[0], { charEncoding: "percent" })();
  ...
  >(
    ...
    M.jsonErr(400, errors.AuthUserinfoApiBadRequestError$inboundSchema),
    M.jsonErr(401, errors.AuthUserinfoApiUnauthorizedError$inboundSchema),
    M.jsonErr(403, errors.AuthUserinfoApiForbiddenError$inboundSchema),
    M.jsonErr(500, errors.AuthUserinfoApiInternalServerError$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
