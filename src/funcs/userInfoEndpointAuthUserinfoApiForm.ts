...
import { AuthUserinfoApiFormServerList } from "../models/operations/authuserinfoapiform.js";
...
export function userInfoEndpointAuthUserinfoApiForm(
  ...
  Result<
    ...
    | errors.AuthUserinfoApiFormBadRequestError
    | errors.AuthUserinfoApiFormUnauthorizedError
    | errors.AuthUserinfoApiFormForbiddenError
    | errors.AuthUserinfoApiFormInternalServerError
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(AuthUserinfoApiFormServerList[0], {
  ...
  >(
    ...
    M.jsonErr(400, errors.AuthUserinfoApiFormBadRequestError$inboundSchema),
    M.jsonErr(401, errors.AuthUserinfoApiFormUnauthorizedError$inboundSchema),
    M.jsonErr(403, errors.AuthUserinfoApiFormForbiddenError$inboundSchema),
    M.jsonErr(500, errors.AuthUserinfoApiFormInternalServerError$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
