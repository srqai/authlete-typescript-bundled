...
import { AuthRevocationApiServerList } from "../models/operations/authrevocationapi.js";
...
export function revocationEndpointAuthRevocationApi(
  ...
  Result<
    ...
    | errors.AuthRevocationApiBadRequestError
    | errors.AuthRevocationApiUnauthorizedError
    | errors.AuthRevocationApiForbiddenError
    | errors.AuthRevocationApiInternalServerError
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(AuthRevocationApiServerList[0], {
  ...
  >(
    ...
    M.jsonErr(400, errors.AuthRevocationApiBadRequestError$inboundSchema),
    M.jsonErr(401, errors.AuthRevocationApiUnauthorizedError$inboundSchema),
    M.jsonErr(403, errors.AuthRevocationApiForbiddenError$inboundSchema),
    M.jsonErr(500, errors.AuthRevocationApiInternalServerError$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
