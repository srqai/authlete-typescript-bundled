...
import { BackchannelAuthenticationFailApiFormServerList } from "../models/operations/backchannelauthenticationfailapiform.js";
...
export function cibaBackchannelAuthenticationFailApiForm(
  ...
  Result<
    ...
    | errors.BackchannelAuthenticationFailApiFormBadRequestError
    | errors.BackchannelAuthenticationFailApiFormUnauthorizedError
    | errors.BackchannelAuthenticationFailApiFormForbiddenError
    | errors.BackchannelAuthenticationFailApiFormInternalServerError
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(BackchannelAuthenticationFailApiFormServerList[0], {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.BackchannelAuthenticationFailApiFormBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors
    ...
    M.jsonErr(
      403,
      errors.BackchannelAuthenticationFailApiFormForbiddenError$inboundSchema,
    ),
    M.jsonErr(
      500,
      errors
