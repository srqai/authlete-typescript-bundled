...
import { AuthAuthorizationFailApiServerList } from "../models/operations/authauthorizationfailapi.js";
...
export function authorizationEndpointAuthAuthorizationFailApi(
  ...
  Result<
    ...
    | errors.AuthAuthorizationFailApiBadRequestError
    | errors.AuthAuthorizationFailApiUnauthorizedError
    | errors.AuthAuthorizationFailApiForbiddenError
    | errors.AuthAuthorizationFailApiInternalServerError
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(AuthAuthorizationFailApiServerList[0], {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.AuthAuthorizationFailApiBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.AuthAuthorizationFailApiUnauthorizedError$inboundSchema,
    ),
    M.jsonErr(403, errors.AuthAuthorizationFailApiForbiddenError$inboundSchema),
    M.jsonErr(
      500,
      errors.AuthAuthorizationFailApiInternalServerError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
