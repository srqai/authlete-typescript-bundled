...
import { AuthUserinfoIssueApiFormServerList } from "../models/operations/authuserinfoissueapiform.js";
...
export function userInfoEndpointAuthUserinfoIssueApiForm(
  ...
  Result<
    ...
    | errors.AuthUserinfoIssueApiFormBadRequestError
    | errors.AuthUserinfoIssueApiFormUnauthorizedError
    | errors.AuthUserinfoIssueApiFormForbiddenError
    | errors.AuthUserinfoIssueApiFormInternalServerError
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(AuthUserinfoIssueApiFormServerList[0], {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.AuthUserinfoIssueApiFormBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.AuthUserinfoIssueApiFormUnauthorizedError$inboundSchema,
    ),
    M.jsonErr(403, errors.AuthUserinfoIssueApiFormForbiddenError$inboundSchema),
    M.jsonErr(
      500,
      errors.AuthUserinfoIssueApiFormInternalServerError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
