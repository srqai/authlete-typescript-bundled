...
import { ClientRegistrationUpdateApiFormServerList } from "../models/operations/clientregistrationupdateapiform.js";
...
export function dynamicClientRegistrationClientRegistrationUpdateApiForm(
  ...
  Result<
    ...
    | errors.ClientRegistrationUpdateApiFormBadRequestError
    | errors.ClientRegistrationUpdateApiFormUnauthorizedError
    | errors.ClientRegistrationUpdateApiFormForbiddenError
    | errors.ClientRegistrationUpdateApiFormInternalServerError
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(ClientRegistrationUpdateApiFormServerList[0], {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.ClientRegistrationUpdateApiFormBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ClientRegistrationUpdateApiFormUnauthorizedError$inboundSchema,
    ),
    M.jsonErr(
      403,
      errors.ClientRegistrationUpdateApiFormForbiddenError$inboundSchema,
    ),
    M.jsonErr(
      500,
      errors.ClientRegistrationUpdateApiFormInternalServerError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
