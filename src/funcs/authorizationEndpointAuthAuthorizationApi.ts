...
import { AuthAuthorizationApiServerList } from "../models/operations/authauthorizationapi.js";
...
export function authorizationEndpointAuthAuthorizationApi(
  ...
  Result<
    ...
    | errors.AuthAuthorizationApiBadRequestError
    | errors.AuthAuthorizationApiUnauthorizedError
    | errors.AuthAuthorizationApiForbiddenError
    | errors.AuthAuthorizationApiInternalServerError
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(AuthAuthorizationApiServerList[0], {
  ...
  >(
    ...
    M.jsonErr(400, errors.AuthAuthorizationApiBadRequestError$inboundSchema),
    M.jsonErr(401, errors.AuthAuthorizationApiUnauthorizedError$inboundSchema),
    M.jsonErr(403, errors.AuthAuthorizationApiForbiddenError$inboundSchema),
    M.jsonErr(
      500,
      errors.AuthAuthorizationApiInternalServerError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
