...
import { DeviceCompleteApiFormServerList } from "../models/operations/devicecompleteapiform.js";
...
export function deviceFlowDeviceCompleteApiForm(
  ...
  Result<
    ...
    | errors.DeviceCompleteApiFormBadRequestError
    | errors.DeviceCompleteApiFormUnauthorizedError
    | errors.DeviceCompleteApiFormForbiddenError
    | errors.DeviceCompleteApiFormInternalServerError
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(DeviceCompleteApiFormServerList[0], {
  ...
  >(
    ...
    M.jsonErr(400, errors.DeviceCompleteApiFormBadRequestError$inboundSchema),
    M.jsonErr(401, errors.DeviceCompleteApiFormUnauthorizedError$inboundSchema),
    M.jsonErr(403, errors.DeviceCompleteApiFormForbiddenError$inboundSchema),
    M.jsonErr(
      500,
      errors.DeviceCompleteApiFormInternalServerError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
