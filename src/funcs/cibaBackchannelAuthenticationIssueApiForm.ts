...
import { BackchannelAuthenticationIssueApiFormServerList } from "../models/operations/backchannelauthenticationissueapiform.js";
...
export function cibaBackchannelAuthenticationIssueApiForm(
  ...
  Result<
    ...
    | errors.BackchannelAuthenticationIssueApiFormBadRequestError
    | errors.BackchannelAuthenticationIssueApiFormUnauthorizedError
    | errors.BackchannelAuthenticationIssueApiFormForbiddenError
    | errors.BackchannelAuthenticationIssueApiFormInternalServerError
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(BackchannelAuthenticationIssueApiFormServerList[0], {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.BackchannelAuthenticationIssueApiFormBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors
    ...
    M.jsonErr(
      403,
      errors.BackchannelAuthenticationIssueApiFormForbiddenError$inboundSchema,
    ),
    M.jsonErr(
      500,
      errors
