...
import { AuthIntrospectionStandardApiServerList } from "../models/operations/authintrospectionstandardapi.js";
...
export function introspectionEndpointAuthIntrospectionStandardApi(
  ...
  Result<
    ...
    | errors.AuthIntrospectionStandardApiBadRequestError
    | errors.AuthIntrospectionStandardApiUnauthorizedError
    | errors.AuthIntrospectionStandardApiForbiddenError
    | errors.AuthIntrospectionStandardApiInternalServerError
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(AuthIntrospectionStandardApiServerList[0], {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.AuthIntrospectionStandardApiBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.AuthIntrospectionStandardApiUnauthorizedError$inboundSchema,
    ),
    M.jsonErr(
      403,
      errors.AuthIntrospectionStandardApiForbiddenError$inboundSchema,
    ),
    M.jsonErr(
      500,
      errors.AuthIntrospectionStandardApiInternalServerError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
