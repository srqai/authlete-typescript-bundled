...
import { BackchannelAuthenticationCompleteApiFormServerList } from "../models/operations/backchannelauthenticationcompleteapiform.js";
...
export function cibaBackchannelAuthenticationCompleteApiForm(
  ...
  Result<
    ...
    | errors.BackchannelAuthenticationCompleteApiFormBadRequestError
    | errors.BackchannelAuthenticationCompleteApiFormUnauthorizedError
    | errors.BackchannelAuthenticationCompleteApiFormForbiddenError
    | errors.BackchannelAuthenticationCompleteApiFormInternalServerError
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(BackchannelAuthenticationCompleteApiFormServerList[0], {
