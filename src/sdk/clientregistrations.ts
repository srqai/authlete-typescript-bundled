...
import { clientRegistrationsGet } from "../funcs/clientRegistrationsGet.js";
import { ClientSDK, RequestOptions } from "../lib/sdks.js";
import * as operations from "../models/operations/index.js";
import { unwrapAsync } from "../types/fp.js";

export class ClientRegistrations extends ClientSDK {
  /**
   * Get Client
   *
   * @remarks
  ...
  async get(
    ...
    return unwrapAsync(clientRegistrationsGet(
      this,
      request,
      options,
    ));
