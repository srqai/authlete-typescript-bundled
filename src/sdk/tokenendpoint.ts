...
import { tokenEndpointProcess } from "../funcs/tokenEndpointProcess.js";
import { tokenEndpointProcessForm } from "../funcs/tokenEndpointProcessForm.js";
...
export class TokenEndpoint extends ClientSDK {
  ...
  async process(
    ...
    return unwrapAsync(tokenEndpointProcess(
      this,
      request,
      options,
    ));
  ...
  async processForm(
    ...
    return unwrapAsync(tokenEndpointProcessForm(
      this,
      request,
      options,
    ));
