...
import { federationRegister } from "../funcs/federationRegister.js";
import { federationRegisterForm } from "../funcs/federationRegisterForm.js";
...
export class Federation extends ClientSDK {
  ...
  async register(
    ...
    return unwrapAsync(federationRegister(
      this,
      request,
      options,
    ));
  ...
  async registerForm(
    ...
    return unwrapAsync(federationRegisterForm(
      this,
      request,
      options,
    ));
