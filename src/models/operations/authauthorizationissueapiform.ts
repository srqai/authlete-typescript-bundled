...
export const AuthAuthorizationIssueApiFormServerList = [
  /**
   * 🇺🇸 US Cluster
   */
...
export type AuthAuthorizationIssueApiFormRequestBody = {
  /**
...
export type AuthAuthorizationIssueApiFormRequest = {
   ...
   */
  serviceId: string;
  requestBody: AuthAuthorizationIssueApiFormRequestBody;
};
...
/** @internal */
export const AuthAuthorizationIssueApiFormRequestBody$inboundSchema: z.ZodType<
...
/** @internal */
export type AuthAuthorizationIssueApiFormRequestBody$Outbound = {
  clientLocked: boolean;
};

/** @internal */
export const AuthAuthorizationIssueApiFormRequestBody$outboundSchema: z.ZodType<
  AuthAuthorizationIssueApiFormRequestBody$Outbound,
  z.ZodTypeDef,
  AuthAuthorizationIssueApiFormRequestBody
> = z.object({
  clientLocked: z.boolean(),
 ...
 */
export namespace AuthAuthorizationIssueApiFormRequestBody$ {
  /** @deprecated use `AuthAuthorizationIssueApiFormRequestBody$inboundSchema` instead. */
  export const inboundSchema =
    AuthAuthorizationIssueApiFormRequestBody$inboundSchema;
  /** @deprecated use `AuthAuthorizationIssueApiFormRequestBody$outboundSchema` instead. */
  export const outboundSchema =
    AuthAuthorizationIssueApiFormRequestBody$outboundSchema;
  /** @deprecated use `AuthAuthorizationIssueApiFormRequestBody$Outbound` instead. */
  export type Outbound = AuthAuthorizationIssueApiFormRequestBody$Outbound;
}

export function authAuthorizationIssueApiFormRequestBodyToJSON(
  authAuthorizationIssueApiFormRequestBody:
    AuthAuthorizationIssueApiFormRequestBody,
): string {
  return JSON.stringify(
    AuthAuthorizationIssueApiFormRequestBody$outboundSchema.parse(
      authAuthorizationIssueApiFormRequestBody,
    ),
  );
}

export function authAuthorizationIssueApiFormRequestBodyFromJSON(
  jsonString: string,
): SafeParseResult<
  AuthAuthorizationIssueApiFormRequestBody,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      AuthAuthorizationIssueApiFormRequestBody$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'AuthAuthorizationIssueApiFormRequestBody' from JSON`,
  );
}
...
export type AuthAuthorizationIssueApiFormRequest$Outbound = {
  serviceId: string;
  RequestBody: AuthAuthorizationIssueApiFormRequestBody$Outbound;
};
