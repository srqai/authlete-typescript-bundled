...
export const BackchannelAuthenticationIssueApiFormServerList = [
  /**
   * 🇺🇸 US Cluster
   */
...
export type BackchannelAuthenticationIssueApiFormRequestBody = {
  /**
...
export type BackchannelAuthenticationIssueApiFormRequest = {
   ...
   */
  serviceId: string;
  requestBody: BackchannelAuthenticationIssueApiFormRequestBody;
};
...
/** @internal */
export const BackchannelAuthenticationIssueApiFormRequestBody$inboundSchema:
  z.ZodType<
...
/** @internal */
export type BackchannelAuthenticationIssueApiFormRequestBody$Outbound = {
  clientLocked: boolean;
};

/** @internal */
export const BackchannelAuthenticationIssueApiFormRequestBody$outboundSchema:
  z.ZodType<
    BackchannelAuthenticationIssueApiFormRequestBody$Outbound,
    z.ZodTypeDef,
    BackchannelAuthenticationIssueApiFormRequestBody
  > = z.object({
    clientLocked: z.boolean(),
 ...
 */
export namespace BackchannelAuthenticationIssueApiFormRequestBody$ {
  /** @deprecated use `BackchannelAuthenticationIssueApiFormRequestBody$inboundSchema` instead. */
  export const inboundSchema =
    BackchannelAuthenticationIssueApiFormRequestBody$inboundSchema;
  /** @deprecated use `BackchannelAuthenticationIssueApiFormRequestBody$outboundSchema` instead. */
  export const outboundSchema =
    BackchannelAuthenticationIssueApiFormRequestBody$outboundSchema;
  /** @deprecated use `BackchannelAuthenticationIssueApiFormRequestBody$Outbound` instead. */
  export type Outbound =
    BackchannelAuthenticationIssueApiFormRequestBody$Outbound;
}

export function backchannelAuthenticationIssueApiFormRequestBodyToJSON(
  backchannelAuthenticationIssueApiFormRequestBody:
    BackchannelAuthenticationIssueApiFormRequestBody,
): string {
  return JSON.stringify(
    BackchannelAuthenticationIssueApiFormRequestBody$outboundSchema.parse(
      backchannelAuthenticationIssueApiFormRequestBody,
    ),
  );
}

export function backchannelAuthenticationIssueApiFormRequestBodyFromJSON(
  jsonString: string,
): SafeParseResult<
  BackchannelAuthenticationIssueApiFormRequestBody,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      BackchannelAuthenticationIssueApiFormRequestBody$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'BackchannelAuthenticationIssueApiFormRequestBody' from JSON`,
  );
}
...
export type BackchannelAuthenticationIssueApiFormRequest$Outbound = {
  serviceId: string;
  RequestBody: BackchannelAuthenticationIssueApiFormRequestBody$Outbound;
};
