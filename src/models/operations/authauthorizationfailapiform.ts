...
export const AuthAuthorizationFailApiFormServerList = [
  /**
   * 🇺🇸 US Cluster
   */
...
export type AuthAuthorizationFailApiFormRequestBody = {
  /**
...
export type AuthAuthorizationFailApiFormRequest = {
   ...
   */
  serviceId: string;
  requestBody: AuthAuthorizationFailApiFormRequestBody;
};
...
/** @internal */
export const AuthAuthorizationFailApiFormRequestBody$inboundSchema: z.ZodType<
...
/** @internal */
export type AuthAuthorizationFailApiFormRequestBody$Outbound = {
  clientLocked: boolean;
};

/** @internal */
export const AuthAuthorizationFailApiFormRequestBody$outboundSchema: z.ZodType<
  AuthAuthorizationFailApiFormRequestBody$Outbound,
  z.ZodTypeDef,
  AuthAuthorizationFailApiFormRequestBody
> = z.object({
  clientLocked: z.boolean(),
 ...
 */
export namespace AuthAuthorizationFailApiFormRequestBody$ {
  /** @deprecated use `AuthAuthorizationFailApiFormRequestBody$inboundSchema` instead. */
  export const inboundSchema =
    AuthAuthorizationFailApiFormRequestBody$inboundSchema;
  /** @deprecated use `AuthAuthorizationFailApiFormRequestBody$outboundSchema` instead. */
  export const outboundSchema =
    AuthAuthorizationFailApiFormRequestBody$outboundSchema;
  /** @deprecated use `AuthAuthorizationFailApiFormRequestBody$Outbound` instead. */
  export type Outbound = AuthAuthorizationFailApiFormRequestBody$Outbound;
}

export function authAuthorizationFailApiFormRequestBodyToJSON(
  authAuthorizationFailApiFormRequestBody:
    AuthAuthorizationFailApiFormRequestBody,
): string {
  return JSON.stringify(
    AuthAuthorizationFailApiFormRequestBody$outboundSchema.parse(
      authAuthorizationFailApiFormRequestBody,
    ),
  );
}

export function authAuthorizationFailApiFormRequestBodyFromJSON(
  jsonString: string,
): SafeParseResult<
  AuthAuthorizationFailApiFormRequestBody,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      AuthAuthorizationFailApiFormRequestBody$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'AuthAuthorizationFailApiFormRequestBody' from JSON`,
  );
}
...
export type AuthAuthorizationFailApiFormRequest$Outbound = {
  serviceId: string;
  RequestBody: AuthAuthorizationFailApiFormRequestBody$Outbound;
};
