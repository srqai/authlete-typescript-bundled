...
export const VciSingleParseApiServerList = [
  /**
   * 🇺🇸 US Cluster
   */
...
export type VciSingleParseApiInfo = {
  /**
...
export type VciSingleParseApiResponse = {
  ...
  info?: VciSingleParseApiInfo | undefined;
};
...
/** @internal */
export const VciSingleParseApiInfo$inboundSchema: z.ZodType<
...
/** @internal */
export type VciSingleParseApiInfo$Outbound = {
  identifier?: string | undefined;
  format?: string | undefined;
  bindingKey?: string | undefined;
  details?: string | undefined;
...
/** @internal */
export const VciSingleParseApiInfo$outboundSchema: z.ZodType<
  VciSingleParseApiInfo$Outbound,
  z.ZodTypeDef,
  VciSingleParseApiInfo
> = z.object({
  identifier: z.string().optional(),
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace VciSingleParseApiInfo$ {
  /** @deprecated use `VciSingleParseApiInfo$inboundSchema` instead. */
  export const inboundSchema = VciSingleParseApiInfo$inboundSchema;
  /** @deprecated use `VciSingleParseApiInfo$outboundSchema` instead. */
  export const outboundSchema = VciSingleParseApiInfo$outboundSchema;
  /** @deprecated use `VciSingleParseApiInfo$Outbound` instead. */
  export type Outbound = VciSingleParseApiInfo$Outbound;
}

export function vciSingleParseApiInfoToJSON(
  vciSingleParseApiInfo: VciSingleParseApiInfo,
): string {
  return JSON.stringify(
    VciSingleParseApiInfo$outboundSchema.parse(vciSingleParseApiInfo),
  );
}

export function vciSingleParseApiInfoFromJSON(
  jsonString: string,
): SafeParseResult<VciSingleParseApiInfo, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => VciSingleParseApiInfo$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'VciSingleParseApiInfo' from JSON`,
  );
}
...
> = z.object({
  ...
  info: z.lazy(() => VciSingleParseApiInfo$inboundSchema).optional(),
});
...
export type VciSingleParseApiResponse$Outbound = {
  ...
  responseContent?: string | undefined;
  info?: VciSingleParseApiInfo$Outbound | undefined;
};
...
> = z.object({
  ...
  responseContent: z.string().optional(),
  info: z.lazy(() => VciSingleParseApiInfo$outboundSchema).optional(),
});
