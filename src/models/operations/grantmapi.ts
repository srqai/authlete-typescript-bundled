...
export const GrantMApiServerList = [
  /**
   * 🇺🇸 US Cluster
   */
 ...
 */
export const GrantMApiGmAction = {
  Create: "CREATE",
  Query: "QUERY",
  Replace: "REPLACE",
  Revoke: "REVOKE",
 ...
 * [Grant Management for OAuth 2.0](https://openid.net/specs/fapi-grant-management.html).
 */
export type GrantMApiGmAction = ClosedEnum<typeof GrantMApiGmAction>;
...
export type GrantMApiRequestBody = {
   ...
   * [Grant Management for OAuth 2.0](https://openid.net/specs/fapi-grant-management.html).
   */
  gmAction?: GrantMApiGmAction | undefined;
  /**
...
/** @internal */
export const GrantMApiGmAction$inboundSchema: z.ZodNativeEnum<
  typeof GrantMApiGmAction
> = z.nativeEnum(GrantMApiGmAction);

/** @internal */
export const GrantMApiGmAction$outboundSchema: z.ZodNativeEnum<
  typeof GrantMApiGmAction
> = GrantMApiGmAction$inboundSchema;

/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace GrantMApiGmAction$ {
  /** @deprecated use `GrantMApiGmAction$inboundSchema` instead. */
  export const inboundSchema = GrantMApiGmAction$inboundSchema;
  /** @deprecated use `GrantMApiGmAction$outboundSchema` instead. */
  export const outboundSchema = GrantMApiGmAction$outboundSchema;
}
...
> = z.object({
  ...
  gmAction: GrantMApiGmAction$inboundSchema.optional(),
...
> = z.object({
  ...
  htu: z.string().optional(),
  resources: z.array(z.string()).optional(),
  gmAction: GrantMApiGmAction$outboundSchema.optional(),
  grantId: z.string().optional(),
});
