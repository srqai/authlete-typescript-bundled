...
export const VciBatchIssueApiServerList = [
  /**
   * 🇺🇸 US Cluster
   */
...
export type VciBatchIssueApiOrder = {
  /**
...
export type VciBatchIssueApiRequestBody = {
   ...
   */
  orders?: Array<VciBatchIssueApiOrder> | undefined;
};
...
/** @internal */
export const VciBatchIssueApiOrder$inboundSchema: z.ZodType<
...
/** @internal */
export type VciBatchIssueApiOrder$Outbound = {
  requestIdentifier?: string | undefined;
  credentialPayload?: string | undefined;
  issuanceDeferred?: boolean | undefined;
  credentialDuration?: number | undefined;
...
/** @internal */
export const VciBatchIssueApiOrder$outboundSchema: z.ZodType<
  VciBatchIssueApiOrder$Outbound,
  z.ZodTypeDef,
  VciBatchIssueApiOrder
> = z.object({
  requestIdentifier: z.string().optional(),
 ...
 */
export namespace VciBatchIssueApiOrder$ {
  /** @deprecated use `VciBatchIssueApiOrder$inboundSchema` instead. */
  export const inboundSchema = VciBatchIssueApiOrder$inboundSchema;
  /** @deprecated use `VciBatchIssueApiOrder$outboundSchema` instead. */
  export const outboundSchema = VciBatchIssueApiOrder$outboundSchema;
  /** @deprecated use `VciBatchIssueApiOrder$Outbound` instead. */
  export type Outbound = VciBatchIssueApiOrder$Outbound;
}

export function vciBatchIssueApiOrderToJSON(
  vciBatchIssueApiOrder: VciBatchIssueApiOrder,
): string {
  return JSON.stringify(
    VciBatchIssueApiOrder$outboundSchema.parse(vciBatchIssueApiOrder),
  );
}

export function vciBatchIssueApiOrderFromJSON(
  jsonString: string,
): SafeParseResult<VciBatchIssueApiOrder, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => VciBatchIssueApiOrder$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'VciBatchIssueApiOrder' from JSON`,
  );
}
...
> = z.object({
  ...
  orders: z.array(z.lazy(() => VciBatchIssueApiOrder$inboundSchema)).optional(),
});

/** @internal */
export type VciBatchIssueApiRequestBody$Outbound = {
  accessToken?: string | undefined;
  orders?: Array<VciBatchIssueApiOrder$Outbound> | undefined;
};
...
> = z.object({
  accessToken: z.string().optional(),
  orders: z.array(z.lazy(() => VciBatchIssueApiOrder$outboundSchema))
    .optional(),
});
