...
export const DeviceCompleteApiServerList = [
  /**
   * 🇺🇸 US Cluster
   */
...
export type DeviceCompleteApiProperty = {
  /**
   * The key part.
   */
...
export type DeviceCompleteApiRequestBody = {
   ...
   * @remarks
   */
  properties?: Array<DeviceCompleteApiProperty> | undefined;
  /**
...
/** @internal */
export const DeviceCompleteApiProperty$inboundSchema: z.ZodType<
  DeviceCompleteApiProperty,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export type DeviceCompleteApiProperty$Outbound = {
  key?: string | undefined;
  value?: string | undefined;
  hidden?: boolean | undefined;
};
...
/** @internal */
export const DeviceCompleteApiProperty$outboundSchema: z.ZodType<
  DeviceCompleteApiProperty$Outbound,
  z.ZodTypeDef,
  DeviceCompleteApiProperty
> = z.object({
  key: z.string().optional(),
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace DeviceCompleteApiProperty$ {
  /** @deprecated use `DeviceCompleteApiProperty$inboundSchema` instead. */
  export const inboundSchema = DeviceCompleteApiProperty$inboundSchema;
  /** @deprecated use `DeviceCompleteApiProperty$outboundSchema` instead. */
  export const outboundSchema = DeviceCompleteApiProperty$outboundSchema;
  /** @deprecated use `DeviceCompleteApiProperty$Outbound` instead. */
  export type Outbound = DeviceCompleteApiProperty$Outbound;
}

export function deviceCompleteApiPropertyToJSON(
  deviceCompleteApiProperty: DeviceCompleteApiProperty,
): string {
  return JSON.stringify(
    DeviceCompleteApiProperty$outboundSchema.parse(deviceCompleteApiProperty),
  );
}

export function deviceCompleteApiPropertyFromJSON(
  jsonString: string,
): SafeParseResult<DeviceCompleteApiProperty, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => DeviceCompleteApiProperty$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'DeviceCompleteApiProperty' from JSON`,
  );
}
...
> = z.object({
  ...
  properties: z.array(z.lazy(() => DeviceCompleteApiProperty$inboundSchema))
    .optional(),
...
export type DeviceCompleteApiRequestBody$Outbound = {
  ...
  acr?: string | undefined;
  claims?: string | undefined;
  properties?: Array<DeviceCompleteApiProperty$Outbound> | undefined;
  scopes?: Array<string> | undefined;
  errorDescription?: string | undefined;
  errorUri?: string | undefined;
  idtHeaderParams?: string | undefined;
...
> = z.object({
  ...
  acr: z.string().optional(),
  claims: z.string().optional(),
  properties: z.array(z.lazy(() => DeviceCompleteApiProperty$outboundSchema))
    .optional(),
  scopes: z.array(z.string()).optional(),
  errorDescription: z.string().optional(),
  errorUri: z.string().optional(),
