...
export const BackchannelAuthenticationFailApiFormServerList = [
  /**
   * 🇺🇸 US Cluster
   */
...
export type BackchannelAuthenticationFailApiFormRequestBody = {
  /**
...
export type BackchannelAuthenticationFailApiFormRequest = {
   ...
   */
  serviceId: string;
  requestBody: BackchannelAuthenticationFailApiFormRequestBody;
};
...
/** @internal */
export const BackchannelAuthenticationFailApiFormRequestBody$inboundSchema:
  z.ZodType<
...
/** @internal */
export type BackchannelAuthenticationFailApiFormRequestBody$Outbound = {
  clientLocked: boolean;
};

/** @internal */
export const BackchannelAuthenticationFailApiFormRequestBody$outboundSchema:
  z.ZodType<
    BackchannelAuthenticationFailApiFormRequestBody$Outbound,
    z.ZodTypeDef,
    BackchannelAuthenticationFailApiFormRequestBody
  > = z.object({
    clientLocked: z.boolean(),
 ...
 */
export namespace BackchannelAuthenticationFailApiFormRequestBody$ {
  /** @deprecated use `BackchannelAuthenticationFailApiFormRequestBody$inboundSchema` instead. */
  export const inboundSchema =
    BackchannelAuthenticationFailApiFormRequestBody$inboundSchema;
  /** @deprecated use `BackchannelAuthenticationFailApiFormRequestBody$outboundSchema` instead. */
  export const outboundSchema =
    BackchannelAuthenticationFailApiFormRequestBody$outboundSchema;
  /** @deprecated use `BackchannelAuthenticationFailApiFormRequestBody$Outbound` instead. */
  export type Outbound =
    BackchannelAuthenticationFailApiFormRequestBody$Outbound;
}

export function backchannelAuthenticationFailApiFormRequestBodyToJSON(
  backchannelAuthenticationFailApiFormRequestBody:
    BackchannelAuthenticationFailApiFormRequestBody,
): string {
  return JSON.stringify(
    BackchannelAuthenticationFailApiFormRequestBody$outboundSchema.parse(
      backchannelAuthenticationFailApiFormRequestBody,
    ),
  );
}

export function backchannelAuthenticationFailApiFormRequestBodyFromJSON(
  jsonString: string,
): SafeParseResult<
  BackchannelAuthenticationFailApiFormRequestBody,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      BackchannelAuthenticationFailApiFormRequestBody$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'BackchannelAuthenticationFailApiFormRequestBody' from JSON`,
  );
}
...
export type BackchannelAuthenticationFailApiFormRequest$Outbound = {
  serviceId: string;
  RequestBody: BackchannelAuthenticationFailApiFormRequestBody$Outbound;
};
