...
export const ClientSecretUpdateApiFormServerList = [
  /**
   * 🇺🇸 US Cluster
   */
...
export type ClientSecretUpdateApiFormRequestBody = {
  /**
...
export type ClientSecretUpdateApiFormRequest = {
  ...
  requestBody: ClientSecretUpdateApiFormRequestBody;
};
...
/** @internal */
export const ClientSecretUpdateApiFormRequestBody$inboundSchema: z.ZodType<
...
/** @internal */
export type ClientSecretUpdateApiFormRequestBody$Outbound = {
  clientLocked: boolean;
};

/** @internal */
export const ClientSecretUpdateApiFormRequestBody$outboundSchema: z.ZodType<
  ClientSecretUpdateApiFormRequestBody$Outbound,
  z.ZodTypeDef,
  ClientSecretUpdateApiFormRequestBody
> = z.object({
  clientLocked: z.boolean(),
 ...
 */
export namespace ClientSecretUpdateApiFormRequestBody$ {
  /** @deprecated use `ClientSecretUpdateApiFormRequestBody$inboundSchema` instead. */
  export const inboundSchema =
    ClientSecretUpdateApiFormRequestBody$inboundSchema;
  /** @deprecated use `ClientSecretUpdateApiFormRequestBody$outboundSchema` instead. */
  export const outboundSchema =
    ClientSecretUpdateApiFormRequestBody$outboundSchema;
  /** @deprecated use `ClientSecretUpdateApiFormRequestBody$Outbound` instead. */
  export type Outbound = ClientSecretUpdateApiFormRequestBody$Outbound;
}

export function clientSecretUpdateApiFormRequestBodyToJSON(
  clientSecretUpdateApiFormRequestBody: ClientSecretUpdateApiFormRequestBody,
): string {
  return JSON.stringify(
    ClientSecretUpdateApiFormRequestBody$outboundSchema.parse(
      clientSecretUpdateApiFormRequestBody,
    ),
  );
}

export function clientSecretUpdateApiFormRequestBodyFromJSON(
  jsonString: string,
): SafeParseResult<ClientSecretUpdateApiFormRequestBody, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      ClientSecretUpdateApiFormRequestBody$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ClientSecretUpdateApiFormRequestBody' from JSON`,
  );
}
...
> = z.object({
  ...
  RequestBody: z.lazy(() => ClientSecretUpdateApiFormRequestBody$inboundSchema),
}).transform((v) => {
  return remap$(v, {
...
export type ClientSecretUpdateApiFormRequest$Outbound = {
  serviceId: string;
  clientIdentifier: string;
  RequestBody: ClientSecretUpdateApiFormRequestBody$Outbound;
};
