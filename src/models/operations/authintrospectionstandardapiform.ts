...
export const AuthIntrospectionStandardApiFormServerList = [
  /**
   * 🇺🇸 US Cluster
   */
...
export type AuthIntrospectionStandardApiFormRequestBody = {
  /**
...
export type AuthIntrospectionStandardApiFormRequest = {
   ...
   */
  serviceId: string;
  requestBody: AuthIntrospectionStandardApiFormRequestBody;
};
...
/** @internal */
export const AuthIntrospectionStandardApiFormRequestBody$inboundSchema:
  z.ZodType<
...
/** @internal */
export type AuthIntrospectionStandardApiFormRequestBody$Outbound = {
  clientLocked: boolean;
};

/** @internal */
export const AuthIntrospectionStandardApiFormRequestBody$outboundSchema:
  z.ZodType<
    AuthIntrospectionStandardApiFormRequestBody$Outbound,
    z.ZodTypeDef,
    AuthIntrospectionStandardApiFormRequestBody
  > = z.object({
    clientLocked: z.boolean(),
 ...
 */
export namespace AuthIntrospectionStandardApiFormRequestBody$ {
  /** @deprecated use `AuthIntrospectionStandardApiFormRequestBody$inboundSchema` instead. */
  export const inboundSchema =
    AuthIntrospectionStandardApiFormRequestBody$inboundSchema;
  /** @deprecated use `AuthIntrospectionStandardApiFormRequestBody$outboundSchema` instead. */
  export const outboundSchema =
    AuthIntrospectionStandardApiFormRequestBody$outboundSchema;
  /** @deprecated use `AuthIntrospectionStandardApiFormRequestBody$Outbound` instead. */
  export type Outbound = AuthIntrospectionStandardApiFormRequestBody$Outbound;
}

export function authIntrospectionStandardApiFormRequestBodyToJSON(
  authIntrospectionStandardApiFormRequestBody:
    AuthIntrospectionStandardApiFormRequestBody,
): string {
  return JSON.stringify(
    AuthIntrospectionStandardApiFormRequestBody$outboundSchema.parse(
      authIntrospectionStandardApiFormRequestBody,
    ),
  );
}

export function authIntrospectionStandardApiFormRequestBodyFromJSON(
  jsonString: string,
): SafeParseResult<
  AuthIntrospectionStandardApiFormRequestBody,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      AuthIntrospectionStandardApiFormRequestBody$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'AuthIntrospectionStandardApiFormRequestBody' from JSON`,
  );
}
...
export type AuthIntrospectionStandardApiFormRequest$Outbound = {
  serviceId: string;
  RequestBody: AuthIntrospectionStandardApiFormRequestBody$Outbound;
};
