...
export const HskCreateApiServerList = [
  /**
   * 🇺🇸 US Cluster
   */
...
/** @internal */
export const HskCreateApiHsk$inboundSchema: z.ZodType<
  HskCreateApiHsk,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export type HskCreateApiHsk$Outbound = {
  kty?: string | undefined;
  use?: string | undefined;
  kid?: string | undefined;
  hsmName?: string | undefined;
...
/** @internal */
export const HskCreateApiHsk$outboundSchema: z.ZodType<
  HskCreateApiHsk$Outbound,
  z.ZodTypeDef,
  HskCreateApiHsk
> = z.object({
  kty: z.string().optional(),
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace HskCreateApiHsk$ {
  /** @deprecated use `HskCreateApiHsk$inboundSchema` instead. */
  export const inboundSchema = HskCreateApiHsk$inboundSchema;
  /** @deprecated use `HskCreateApiHsk$outboundSchema` instead. */
  export const outboundSchema = HskCreateApiHsk$outboundSchema;
  /** @deprecated use `HskCreateApiHsk$Outbound` instead. */
  export type Outbound = HskCreateApiHsk$Outbound;
}

export function hskCreateApiHskToJSON(
  hskCreateApiHsk: HskCreateApiHsk,
): string {
  return JSON.stringify(HskCreateApiHsk$outboundSchema.parse(hskCreateApiHsk));
}

export function hskCreateApiHskFromJSON(
  jsonString: string,
): SafeParseResult<HskCreateApiHsk, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => HskCreateApiHsk$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'HskCreateApiHsk' from JSON`,
  );
}
...
> = z.object({
  ...
  hsk: z.lazy(() => HskCreateApiHsk$inboundSchema).optional(),
});
...
export type HskCreateApiResponse$Outbound = {
  ...
  hsk?: HskCreateApiHsk$Outbound | undefined;
};
...
> = z.object({
  ...
  hsk: z.lazy(() => HskCreateApiHsk$outboundSchema).optional(),
});
