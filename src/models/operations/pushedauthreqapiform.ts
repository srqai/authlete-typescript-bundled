...
export const PushedAuthReqApiFormServerList = [
  /**
   * 🇺🇸 US Cluster
   */
...
export type PushedAuthReqApiFormRequestBody = {
  /**
...
export type PushedAuthReqApiFormRequest = {
   ...
   */
  serviceId: string;
  requestBody: PushedAuthReqApiFormRequestBody;
};
...
/** @internal */
export const PushedAuthReqApiFormRequestBody$inboundSchema: z.ZodType<
...
/** @internal */
export type PushedAuthReqApiFormRequestBody$Outbound = {
  clientLocked: boolean;
};

/** @internal */
export const PushedAuthReqApiFormRequestBody$outboundSchema: z.ZodType<
  PushedAuthReqApiFormRequestBody$Outbound,
  z.ZodTypeDef,
  PushedAuthReqApiFormRequestBody
> = z.object({
  clientLocked: z.boolean(),
 ...
 */
export namespace PushedAuthReqApiFormRequestBody$ {
  /** @deprecated use `PushedAuthReqApiFormRequestBody$inboundSchema` instead. */
  export const inboundSchema = PushedAuthReqApiFormRequestBody$inboundSchema;
  /** @deprecated use `PushedAuthReqApiFormRequestBody$outboundSchema` instead. */
  export const outboundSchema = PushedAuthReqApiFormRequestBody$outboundSchema;
  /** @deprecated use `PushedAuthReqApiFormRequestBody$Outbound` instead. */
  export type Outbound = PushedAuthReqApiFormRequestBody$Outbound;
}

export function pushedAuthReqApiFormRequestBodyToJSON(
  pushedAuthReqApiFormRequestBody: PushedAuthReqApiFormRequestBody,
): string {
  return JSON.stringify(
    PushedAuthReqApiFormRequestBody$outboundSchema.parse(
      pushedAuthReqApiFormRequestBody,
    ),
  );
}

export function pushedAuthReqApiFormRequestBodyFromJSON(
  jsonString: string,
): SafeParseResult<PushedAuthReqApiFormRequestBody, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => PushedAuthReqApiFormRequestBody$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'PushedAuthReqApiFormRequestBody' from JSON`,
  );
}
...
> = z.object({
  serviceId: z.string(),
  RequestBody: z.lazy(() => PushedAuthReqApiFormRequestBody$inboundSchema),
}).transform((v) => {
  return remap$(v, {
...
export type PushedAuthReqApiFormRequest$Outbound = {
  serviceId: string;
  RequestBody: PushedAuthReqApiFormRequestBody$Outbound;
};
...
> = z.object({
  serviceId: z.string(),
  requestBody: z.lazy(() => PushedAuthReqApiFormRequestBody$outboundSchema),
}).transform((v) => {
  return remap$(v, {
    requestBody: "RequestBody",
  });
