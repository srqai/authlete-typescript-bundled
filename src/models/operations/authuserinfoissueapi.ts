...
export const AuthUserinfoIssueApiServerList = [
  /**
   * 🇺🇸 US Cluster
   */
...
export type AuthUserinfoIssueApiHeader = {
  /**
   * The key part.
   */
...
export type AuthUserinfoIssueApiRequestBody = {
   ...
   */
  headers?: Array<AuthUserinfoIssueApiHeader> | undefined;
};
...
/** @internal */
export const AuthUserinfoIssueApiHeader$inboundSchema: z.ZodType<
...
/** @internal */
export type AuthUserinfoIssueApiHeader$Outbound = {
  key?: string | undefined;
  value?: string | undefined;
};

/** @internal */
export const AuthUserinfoIssueApiHeader$outboundSchema: z.ZodType<
  AuthUserinfoIssueApiHeader$Outbound,
  z.ZodTypeDef,
  AuthUserinfoIssueApiHeader
> = z.object({
  key: z.string().optional(),
 ...
 */
export namespace AuthUserinfoIssueApiHeader$ {
  /** @deprecated use `AuthUserinfoIssueApiHeader$inboundSchema` instead. */
  export const inboundSchema = AuthUserinfoIssueApiHeader$inboundSchema;
  /** @deprecated use `AuthUserinfoIssueApiHeader$outboundSchema` instead. */
  export const outboundSchema = AuthUserinfoIssueApiHeader$outboundSchema;
  /** @deprecated use `AuthUserinfoIssueApiHeader$Outbound` instead. */
  export type Outbound = AuthUserinfoIssueApiHeader$Outbound;
}

export function authUserinfoIssueApiHeaderToJSON(
  authUserinfoIssueApiHeader: AuthUserinfoIssueApiHeader,
): string {
  return JSON.stringify(
    AuthUserinfoIssueApiHeader$outboundSchema.parse(authUserinfoIssueApiHeader),
  );
}

export function authUserinfoIssueApiHeaderFromJSON(
  jsonString: string,
): SafeParseResult<AuthUserinfoIssueApiHeader, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => AuthUserinfoIssueApiHeader$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'AuthUserinfoIssueApiHeader' from JSON`,
  );
}
...
> = z.object({
  ...
  headers: z.array(z.lazy(() => AuthUserinfoIssueApiHeader$inboundSchema))
    .optional(),
});
...
export type AuthUserinfoIssueApiRequestBody$Outbound = {
  ...
  claimsForTx?: string | undefined;
  requestSignature?: string | undefined;
  headers?: Array<AuthUserinfoIssueApiHeader$Outbound> | undefined;
};
...
> = z.object({
  ...
  claimsForTx: z.string().optional(),
  requestSignature: z.string().optional(),
  headers: z.array(z.lazy(() => AuthUserinfoIssueApiHeader$outboundSchema))
    .optional(),
});
