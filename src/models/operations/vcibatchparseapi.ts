...
export const VciBatchParseApiServerList = [
  /**
   * 🇺🇸 US Cluster
   */
...
export type VciBatchParseApiInfo = {
  /**
...
export type VciBatchParseApiResponse = {
   ...
   * request.
   */
  info?: Array<VciBatchParseApiInfo> | undefined;
};
...
/** @internal */
export const VciBatchParseApiInfo$inboundSchema: z.ZodType<
...
/** @internal */
export type VciBatchParseApiInfo$Outbound = {
  identifier?: string | undefined;
  format?: string | undefined;
  bindingKey?: string | undefined;
  details?: string | undefined;
...
/** @internal */
export const VciBatchParseApiInfo$outboundSchema: z.ZodType<
  VciBatchParseApiInfo$Outbound,
  z.ZodTypeDef,
  VciBatchParseApiInfo
> = z.object({
  identifier: z.string().optional(),
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace VciBatchParseApiInfo$ {
  /** @deprecated use `VciBatchParseApiInfo$inboundSchema` instead. */
  export const inboundSchema = VciBatchParseApiInfo$inboundSchema;
  /** @deprecated use `VciBatchParseApiInfo$outboundSchema` instead. */
  export const outboundSchema = VciBatchParseApiInfo$outboundSchema;
  /** @deprecated use `VciBatchParseApiInfo$Outbound` instead. */
  export type Outbound = VciBatchParseApiInfo$Outbound;
}

export function vciBatchParseApiInfoToJSON(
  vciBatchParseApiInfo: VciBatchParseApiInfo,
): string {
  return JSON.stringify(
    VciBatchParseApiInfo$outboundSchema.parse(vciBatchParseApiInfo),
  );
}

export function vciBatchParseApiInfoFromJSON(
  jsonString: string,
): SafeParseResult<VciBatchParseApiInfo, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => VciBatchParseApiInfo$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'VciBatchParseApiInfo' from JSON`,
  );
}
...
> = z.object({
  ...
  info: z.array(z.lazy(() => VciBatchParseApiInfo$inboundSchema)).optional(),
});
...
export type VciBatchParseApiResponse$Outbound = {
  ...
  responseContent?: string | undefined;
  info?: Array<VciBatchParseApiInfo$Outbound> | undefined;
};
...
> = z.object({
  ...
  responseContent: z.string().optional(),
  info: z.array(z.lazy(() => VciBatchParseApiInfo$outboundSchema)).optional(),
});
