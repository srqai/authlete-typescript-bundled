...
export const VciJwtissuerApiFormServerList = [
  /**
   * 🇺🇸 US Cluster
   */
...
export type VciJwtissuerApiFormRequestBody = {
  /**
...
export type VciJwtissuerApiFormRequest = {
   ...
   */
  serviceId: string;
  requestBody: VciJwtissuerApiFormRequestBody;
};
...
/** @internal */
export const VciJwtissuerApiFormRequestBody$inboundSchema: z.ZodType<
...
/** @internal */
export type VciJwtissuerApiFormRequestBody$Outbound = {
  clientLocked: boolean;
};

/** @internal */
export const VciJwtissuerApiFormRequestBody$outboundSchema: z.ZodType<
  VciJwtissuerApiFormRequestBody$Outbound,
  z.ZodTypeDef,
  VciJwtissuerApiFormRequestBody
> = z.object({
  clientLocked: z.boolean(),
 ...
 */
export namespace VciJwtissuerApiFormRequestBody$ {
  /** @deprecated use `VciJwtissuerApiFormRequestBody$inboundSchema` instead. */
  export const inboundSchema = VciJwtissuerApiFormRequestBody$inboundSchema;
  /** @deprecated use `VciJwtissuerApiFormRequestBody$outboundSchema` instead. */
  export const outboundSchema = VciJwtissuerApiFormRequestBody$outboundSchema;
  /** @deprecated use `VciJwtissuerApiFormRequestBody$Outbound` instead. */
  export type Outbound = VciJwtissuerApiFormRequestBody$Outbound;
}

export function vciJwtissuerApiFormRequestBodyToJSON(
  vciJwtissuerApiFormRequestBody: VciJwtissuerApiFormRequestBody,
): string {
  return JSON.stringify(
    VciJwtissuerApiFormRequestBody$outboundSchema.parse(
      vciJwtissuerApiFormRequestBody,
    ),
  );
}

export function vciJwtissuerApiFormRequestBodyFromJSON(
  jsonString: string,
): SafeParseResult<VciJwtissuerApiFormRequestBody, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => VciJwtissuerApiFormRequestBody$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'VciJwtissuerApiFormRequestBody' from JSON`,
  );
}
...
> = z.object({
  serviceId: z.string(),
  RequestBody: z.lazy(() => VciJwtissuerApiFormRequestBody$inboundSchema),
}).transform((v) => {
  return remap$(v, {
...
export type VciJwtissuerApiFormRequest$Outbound = {
  serviceId: string;
  RequestBody: VciJwtissuerApiFormRequestBody$Outbound;
};
...
> = z.object({
  serviceId: z.string(),
  requestBody: z.lazy(() => VciJwtissuerApiFormRequestBody$outboundSchema),
}).transform((v) => {
  return remap$(v, {
    requestBody: "RequestBody",
  });
