...
* [metadata](#metadata) - /api/{serviceId}/vci/metadata API
* [metadataForm](#metadataform) - /api/{serviceId}/vci/metadata API
* [parseBatch](#parsebatch) - /api/{serviceId}/vci/batch/parse API
* [parseBatchForm](#parsebatchform) - /api/{serviceId}/vci/batch/parse API
...
async function run() {
  const result = await autheleteBundled.vci.metadata({
    serviceId: "<id>",
    requestBody: {
      pretty: true,
    },
...
import { vciMetadata } from "authelete-bundled/funcs/vciMetadata.js";
...
async function run() {
  const res = await vciMetadata(autheleteBundled, {
    serviceId: "<id>",
    requestBody: {
      pretty: true,
    },
  ...
  if (res.ok) {
    ...
    console.log("vciMetadata failed:", res.error);
  }
}
...
async function run() {
  const result = await autheleteBundled.vci.metadataForm({
    serviceId: "<id>",
    requestBody: {
      clientLocked: true,
    },
...
```typescript
import { AutheleteBundledCore } from "authelete-bundled/core.js";
import { vciMetadataForm } from "authelete-bundled/funcs/vciMetadataForm.js";
...
async function run() {
  const res = await vciMetadataForm(autheleteBundled, {
    serviceId: "<id>",
    requestBody: {
      clientLocked: false,
    },
  ...
  if (res.ok) {
    ...
    console.log("vciMetadataForm failed:", res.error);
  }
}
...
async function run() {
  const result = await autheleteBundled.vci.parseBatch({
    serviceId: "<id>",
    requestBody: {},
  });
...
```typescript
import { AutheleteBundledCore } from "authelete-bundled/core.js";
import { vciParseBatch } from "authelete-bundled/funcs/vciParseBatch.js";
...
async function run() {
  const res = await vciParseBatch(autheleteBundled, {
    serviceId: "<id>",
    requestBody: {},
  });
  if (res.ok) {
    ...
    console.log("vciParseBatch failed:", res.error);
  }
}
...
async function run() {
  const result = await autheleteBundled.vci.parseBatchForm({
    serviceId: "<id>",
    requestBody: {
      clientLocked: true,
    },
...
```typescript
import { AutheleteBundledCore } from "authelete-bundled/core.js";
import { vciParseBatchForm } from "authelete-bundled/funcs/vciParseBatchForm.js";
...
async function run() {
  const res = await vciParseBatchForm(autheleteBundled, {
    serviceId: "<id>",
    requestBody: {
      clientLocked: false,
    },
  ...
  if (res.ok) {
    ...
    console.log("vciParseBatchForm failed:", res.error);
  }
}
