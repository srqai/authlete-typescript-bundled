...
async function run() {
  const result = await autheleteBundled.hardwareSecurityKey.create({
    serviceId: "<id>",
    requestBody: {},
  });
...
import { hardwareSecurityKeyCreate } from "authelete-bundled/funcs/hardwareSecurityKeyCreate.js";
...
async function run() {
  const res = await hardwareSecurityKeyCreate(autheleteBundled, {
    serviceId: "<id>",
    requestBody: {},
  });
  if (res.ok) {
    ...
    console.log("hardwareSecurityKeyCreate failed:", res.error);
  }
}
...
async function run() {
  const result = await autheleteBundled.hardwareSecurityKey.createForm({
    serviceId: "<id>",
    requestBody: {
      clientLocked: false,
    },
...
```typescript
import { AutheleteBundledCore } from "authelete-bundled/core.js";
import { hardwareSecurityKeyCreateForm } from "authelete-bundled/funcs/hardwareSecurityKeyCreateForm.js";
...
async function run() {
  const res = await hardwareSecurityKeyCreateForm(autheleteBundled, {
    serviceId: "<id>",
    requestBody: {
      clientLocked: false,
    },
  ...
  if (res.ok) {
    ...
    console.log("hardwareSecurityKeyCreateForm failed:", res.error);
  }
}
...
async function run() {
  const result = await autheleteBundled.hardwareSecurityKey.get({
    serviceId: "<id>",
    handle: "<value>",
  });
...
```typescript
import { AutheleteBundledCore } from "authelete-bundled/core.js";
import { hardwareSecurityKeyGet } from "authelete-bundled/funcs/hardwareSecurityKeyGet.js";
...
async function run() {
  const res = await hardwareSecurityKeyGet(autheleteBundled, {
    serviceId: "<id>",
    handle: "<value>",
  });
  if (res.ok) {
