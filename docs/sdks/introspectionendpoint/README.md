...
async function run() {
  const result = await autheleteBundled.introspectionEndpoint.authIntrospectionApi({
    serviceId: "<id>",
    requestBody: {
...
import { introspectionEndpointAuthIntrospectionApi } from "authelete-bundled/funcs/introspectionEndpointAuthIntrospectionApi.js";
...
async function run() {
  const res = await introspectionEndpointAuthIntrospectionApi(autheleteBundled, {
    serviceId: "<id>",
    requestBody: {
      token: "VFGsNK-5sXiqterdaR7b5QbRX9VTwVCQB87jbr2_xAI",
      scopes: [
...
| ---------------------------------------------- | ---------------------------------------------- | ---------------------------------------------- |
| errors.AuthIntrospectionApiBadRequestError     | 400                                            | application/json                               |
| errors.AuthIntrospectionApiUnauthorizedError   | 401                                            | application/json                               |
| errors.AuthIntrospectionApiForbiddenError      | 403                                            | application/json                               |
| errors.AuthIntrospectionApiInternalServerError | 500                                            | application/json                               |
...
async function run() {
  const result = await autheleteBundled.introspectionEndpoint.authIntrospectionApiForm({
    serviceId: "<id>",
    requestBody: {
      clientLocked: false,
    },
...
```typescript
import { AutheleteBundledCore } from "authelete-bundled/core.js";
import { introspectionEndpointAuthIntrospectionApiForm } from "authelete-bundled/funcs/introspectionEndpointAuthIntrospectionApiForm.js";
...
async function run() {
  const res = await introspectionEndpointAuthIntrospectionApiForm(autheleteBundled, {
    serviceId: "<id>",
    requestBody: {
      clientLocked: false,
    },
...
| Error Type                                         | Status Code                                        | Content Type                                       |
| -------------------------------------------------- | -------------------------------------------------- | -------------------------------------------------- |
| errors.AuthIntrospectionApiFormBadRequestError     | 400                                                | application/json                                   |
| errors.AuthIntrospectionApiFormUnauthorizedError   | 401                                                | application/json                                   |
| errors.AuthIntrospectionApiFormForbiddenError      | 403                                                | application/json                                   |
| errors.AuthIntrospectionApiFormInternalServerError | 500                                                | application/json                                   |
| errors.AutheleteBundledDefaultError                | 4XX, 5XX                                           | \*/\*                                              |
...
async function run() {
  const result = await autheleteBundled.introspectionEndpoint.authIntrospectionStandardApi({
    serviceId: "<id>",
    requestBody: {
...
```typescript
import { AutheleteBundledCore } from "authelete-bundled/core.js";
import { introspectionEndpointAuthIntrospectionStandardApi } from "authelete-bundled/funcs/introspectionEndpointAuthIntrospectionStandardApi.js";
...
async function run() {
  const res = await introspectionEndpointAuthIntrospectionStandardApi(autheleteBundled, {
    serviceId: "<id>",
    requestBody: {
      parameters: "token=VFGsNK-5sXiqterdaR7b5QbRX9VTwVCQB87jbr2_xAI&token_type_hint=access_token",
    },
...
| Error Type                                             | Status Code                                            | Content Type                                           |
| ------------------------------------------------------ | ------------------------------------------------------ | ------------------------------------------------------ |
| errors.AuthIntrospectionStandardApiBadRequestError     | 400                                                    | application/json                                       |
| errors.AuthIntrospectionStandardApiUnauthorizedError   | 401                                                    | application/json                                       |
| errors.AuthIntrospectionStandardApiForbiddenError      | 403                                                    | application/json                                       |
| errors.AuthIntrospectionStandardApiInternalServerError | 500                                                    | application/json                                       |
| errors.AutheleteBundledDefaultError                    | 4XX, 5XX                                               | \*/\*                                                  |
...
async function run() {
  const result = await autheleteBundled.introspectionEndpoint.authIntrospectionStandardApiForm({
    serviceId: "<id>",
    requestBody: {
      clientLocked: false,
    },
...
```typescript
import { AutheleteBundledCore } from "authelete-bundled/core.js";
import { introspectionEndpointAuthIntrospectionStandardApiForm } from "authelete-bundled/funcs/introspectionEndpointAuthIntrospectionStandardApiForm.js";
...
async function run() {
  const res = await introspectionEndpointAuthIntrospectionStandardApiForm(autheleteBundled, {
    serviceId: "<id>",
    requestBody: {
      clientLocked: false,
    },
...
| Error Type                                                 | Status Code                                                | Content Type                                               |
| ---------------------------------------------------------- | ---------------------------------------------------------- | ---------------------------------------------------------- |
| errors.AuthIntrospectionStandardApiFormBadRequestError     | 400                                                        | application/json                                           |
| errors.AuthIntrospectionStandardApiFormUnauthorizedError   | 401                                                        | application/json                                           |
| errors.AuthIntrospectionStandardApiFormForbiddenError      | 403                                                        | application/json                                           |
| errors.AuthIntrospectionStandardApiFormInternalServerError | 500                                                        | application/json                                           |
| errors.AutheleteBundledDefaultError                        | 4XX, 5XX                                                   | \*/\*                                                      |