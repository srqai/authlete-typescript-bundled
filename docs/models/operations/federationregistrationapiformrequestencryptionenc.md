...
```typescript
import { FederationRegistrationApiFormRequestEncryptionEnc } from "authelete-bundled/models/operations";

let value: FederationRegistrationApiFormRequestEncryptionEnc = "A128CBC_HS256";
```
