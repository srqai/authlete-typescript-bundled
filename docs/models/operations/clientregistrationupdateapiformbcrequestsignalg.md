...
```typescript
import { ClientRegistrationUpdateApiFormBcRequestSignAlg } from "authelete-bundled/models/operations";

let value: ClientRegistrationUpdateApiFormBcRequestSignAlg = "HS512";
```
