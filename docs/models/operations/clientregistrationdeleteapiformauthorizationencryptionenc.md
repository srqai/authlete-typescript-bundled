...
```typescript
import { ClientRegistrationDeleteApiFormAuthorizationEncryptionEnc } from "authelete-bundled/models/operations";

let value: ClientRegistrationDeleteApiFormAuthorizationEncryptionEnc =
  "A128GCM";
```
