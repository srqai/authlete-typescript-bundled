...
```typescript
import { ServiceUpdateApiSupportedIntrospectionAuthMethodResponse } from "authelete-bundled/models/operations";

let value: ServiceUpdateApiSupportedIntrospectionAuthMethodResponse =
  "CLIENT_SECRET_JWT";
```
