...
```typescript
import { FederationRegistrationApiIdTokenEncryptionEnc } from "authelete-bundled/models/operations";

let value: FederationRegistrationApiIdTokenEncryptionEnc = "A192CBC_HS384";
```
