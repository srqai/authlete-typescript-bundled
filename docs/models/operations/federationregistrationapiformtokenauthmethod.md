...
```typescript
import { FederationRegistrationApiFormTokenAuthMethod } from "authelete-bundled/models/operations";

let value: FederationRegistrationApiFormTokenAuthMethod = "CLIENT_SECRET_POST";
```
