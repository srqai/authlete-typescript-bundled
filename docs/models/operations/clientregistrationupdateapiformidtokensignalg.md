...
```typescript
import { ClientRegistrationUpdateApiFormIdTokenSignAlg } from "authelete-bundled/models/operations";

let value: ClientRegistrationUpdateApiFormIdTokenSignAlg = "ES256";
```
