...
```typescript
import { ClientUpdateApiIdTokenEncryptionAlgResponse } from "authelete-bundled/models/operations";

let value: ClientUpdateApiIdTokenEncryptionAlgResponse = "RSA_OAEP_256";
```
