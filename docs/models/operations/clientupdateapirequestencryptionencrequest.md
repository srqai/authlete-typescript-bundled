...
```typescript
import { ClientUpdateApiRequestEncryptionEncRequest } from "authelete-bundled/models/operations";

let value: ClientUpdateApiRequestEncryptionEncRequest = "A256CBC_HS512";
```
