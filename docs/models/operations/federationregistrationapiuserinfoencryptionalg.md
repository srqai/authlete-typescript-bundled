...
```typescript
import { FederationRegistrationApiUserInfoEncryptionAlg } from "authelete-bundled/models/operations";

let value: FederationRegistrationApiUserInfoEncryptionAlg =
  "PBES2_HS512_A256KW";
```
