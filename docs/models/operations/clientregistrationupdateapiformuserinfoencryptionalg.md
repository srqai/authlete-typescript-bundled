...
```typescript
import { ClientRegistrationUpdateApiFormUserInfoEncryptionAlg } from "authelete-bundled/models/operations";

let value: ClientRegistrationUpdateApiFormUserInfoEncryptionAlg = "A128KW";
```
