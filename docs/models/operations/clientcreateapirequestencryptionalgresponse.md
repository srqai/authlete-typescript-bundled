...
```typescript
import { ClientCreateApiRequestEncryptionAlgResponse } from "authelete-bundled/models/operations";

let value: ClientCreateApiRequestEncryptionAlgResponse = "PBES2_HS512_A256KW";
```
