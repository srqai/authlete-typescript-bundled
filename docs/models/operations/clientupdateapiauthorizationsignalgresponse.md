...
```typescript
import { ClientUpdateApiAuthorizationSignAlgResponse } from "authelete-bundled/models/operations";

let value: ClientUpdateApiAuthorizationSignAlgResponse = "ES256K";
```
