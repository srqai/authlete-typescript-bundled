...
```typescript
import { ClientRegistrationUpdateApiFormAuthorizationSignAlg } from "authelete-bundled/models/operations";

let value: ClientRegistrationUpdateApiFormAuthorizationSignAlg = "PS384";
```
