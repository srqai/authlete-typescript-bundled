...
```typescript
import { ClientRegistrationDeleteApiFormRequestSignAlg } from "authelete-bundled/models/operations";

let value: ClientRegistrationDeleteApiFormRequestSignAlg = "ES384";
```
