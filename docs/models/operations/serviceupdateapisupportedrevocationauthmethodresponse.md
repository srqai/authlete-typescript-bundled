...
```typescript
import { ServiceUpdateApiSupportedRevocationAuthMethodResponse } from "authelete-bundled/models/operations";

let value: ServiceUpdateApiSupportedRevocationAuthMethodResponse = "NONE";
```
