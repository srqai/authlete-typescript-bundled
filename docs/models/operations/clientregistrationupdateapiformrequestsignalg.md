...
```typescript
import { ClientRegistrationUpdateApiFormRequestSignAlg } from "authelete-bundled/models/operations";

let value: ClientRegistrationUpdateApiFormRequestSignAlg = "RS384";
```
