...
```typescript
import { FederationRegistrationApiIdTokenEncryptionAlg } from "authelete-bundled/models/operations";

let value: FederationRegistrationApiIdTokenEncryptionAlg = "RSA1_5";
```
