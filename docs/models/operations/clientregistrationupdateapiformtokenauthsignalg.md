...
```typescript
import { ClientRegistrationUpdateApiFormTokenAuthSignAlg } from "authelete-bundled/models/operations";

let value: ClientRegistrationUpdateApiFormTokenAuthSignAlg = "PS384";
```
