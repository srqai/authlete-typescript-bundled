...
```typescript
import { ClientRegistrationUpdateApiAuthorizationEncryptionEnc } from "authelete-bundled/models/operations";

let value: ClientRegistrationUpdateApiAuthorizationEncryptionEnc =
  "A192CBC_HS384";
```
