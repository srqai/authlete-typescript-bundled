...
```typescript
import { ClientRegistrationApiFormAuthorizationEncryptionAlg } from "authelete-bundled/models/operations";

let value: ClientRegistrationApiFormAuthorizationEncryptionAlg = "ECDH_ES";
```
