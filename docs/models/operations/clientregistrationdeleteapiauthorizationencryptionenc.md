...
```typescript
import { ClientRegistrationDeleteApiAuthorizationEncryptionEnc } from "authelete-bundled/models/operations";

let value: ClientRegistrationDeleteApiAuthorizationEncryptionEnc =
  "A192CBC_HS384";
```
