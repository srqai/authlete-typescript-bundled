...
```typescript
import { FederationRegistrationApiRequestEncryptionEnc } from "authelete-bundled/models/operations";

let value: FederationRegistrationApiRequestEncryptionEnc = "A128GCM";
```
