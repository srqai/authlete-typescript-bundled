...
```typescript
import { ClientRegistrationDeleteApiFormUserInfoEncryptionEnc } from "authelete-bundled/models/operations";

let value: ClientRegistrationDeleteApiFormUserInfoEncryptionEnc = "A256GCM";
```
