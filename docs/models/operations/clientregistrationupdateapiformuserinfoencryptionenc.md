...
```typescript
import { ClientRegistrationUpdateApiFormUserInfoEncryptionEnc } from "authelete-bundled/models/operations";

let value: ClientRegistrationUpdateApiFormUserInfoEncryptionEnc = "A128GCM";
```
