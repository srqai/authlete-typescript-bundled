...
```typescript
import { FederationRegistrationApiFormIdTokenEncryptionAlg } from "authelete-bundled/models/operations";

let value: FederationRegistrationApiFormIdTokenEncryptionAlg = "ECDH_ES";
```
