...
```typescript
import { ClientRegistrationUpdateApiTokenAuthSignAlg } from "authelete-bundled/models/operations";

let value: ClientRegistrationUpdateApiTokenAuthSignAlg = "HS256";
```
