...
```typescript
import { ClientRegistrationDeleteApiFormRequestEncryptionAlg } from "authelete-bundled/models/operations";

let value: ClientRegistrationDeleteApiFormRequestEncryptionAlg = "A192KW";
```
