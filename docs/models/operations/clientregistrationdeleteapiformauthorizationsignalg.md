...
```typescript
import { ClientRegistrationDeleteApiFormAuthorizationSignAlg } from "authelete-bundled/models/operations";

let value: ClientRegistrationDeleteApiFormAuthorizationSignAlg = "HS384";
```
