...
```typescript
import { ClientCreateApiUserInfoEncryptionEncRequest } from "authelete-bundled/models/operations";

let value: ClientCreateApiUserInfoEncryptionEncRequest = "A128CBC_HS256";
```
