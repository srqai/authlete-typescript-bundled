...
```typescript
import { ClientRegistrationUpdateApiFormRequestEncryptionAlg } from "authelete-bundled/models/operations";

let value: ClientRegistrationUpdateApiFormRequestEncryptionAlg = "A128GCMKW";
```
