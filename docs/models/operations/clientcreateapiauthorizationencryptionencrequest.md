...
```typescript
import { ClientCreateApiAuthorizationEncryptionEncRequest } from "authelete-bundled/models/operations";

let value: ClientCreateApiAuthorizationEncryptionEncRequest = "A256CBC_HS512";
```
