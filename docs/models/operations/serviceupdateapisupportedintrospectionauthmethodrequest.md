...
```typescript
import { ServiceUpdateApiSupportedIntrospectionAuthMethodRequest } from "authelete-bundled/models/operations";

let value: ServiceUpdateApiSupportedIntrospectionAuthMethodRequest =
  "CLIENT_SECRET_POST";
```
