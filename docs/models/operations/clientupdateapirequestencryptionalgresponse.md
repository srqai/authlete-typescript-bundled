...
```typescript
import { ClientUpdateApiRequestEncryptionAlgResponse } from "authelete-bundled/models/operations";

let value: ClientUpdateApiRequestEncryptionAlgResponse = "A192KW";
```
