...
```typescript
import { ClientRegistrationApiFormAuthorizationEncryptionEnc } from "authelete-bundled/models/operations";

let value: ClientRegistrationApiFormAuthorizationEncryptionEnc = "A192GCM";
```
