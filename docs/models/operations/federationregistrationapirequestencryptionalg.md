...
```typescript
import { FederationRegistrationApiRequestEncryptionAlg } from "authelete-bundled/models/operations";

let value: FederationRegistrationApiRequestEncryptionAlg = "A192KW";
```
