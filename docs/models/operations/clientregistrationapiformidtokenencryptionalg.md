...
```typescript
import { ClientRegistrationApiFormIdTokenEncryptionAlg } from "authelete-bundled/models/operations";

let value: ClientRegistrationApiFormIdTokenEncryptionAlg = "PBES2_HS512_A256KW";
```
