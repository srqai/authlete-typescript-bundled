...
```typescript
import { ClientRegistrationApiFormRequestEncryptionAlg } from "authelete-bundled/models/operations";

let value: ClientRegistrationApiFormRequestEncryptionAlg = "PBES2_HS384_A192KW";
```
