...
```typescript
import { ClientGetListApiAuthorizationEncryptionAlg } from "authelete-bundled/models/operations";

let value: ClientGetListApiAuthorizationEncryptionAlg = "A128GCMKW";
```
