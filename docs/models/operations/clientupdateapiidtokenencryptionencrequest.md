...
```typescript
import { ClientUpdateApiIdTokenEncryptionEncRequest } from "authelete-bundled/models/operations";

let value: ClientUpdateApiIdTokenEncryptionEncRequest = "A256GCM";
```
