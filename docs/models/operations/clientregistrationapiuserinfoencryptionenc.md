...
```typescript
import { ClientRegistrationApiUserInfoEncryptionEnc } from "authelete-bundled/models/operations";

let value: ClientRegistrationApiUserInfoEncryptionEnc = "A192CBC_HS384";
```
