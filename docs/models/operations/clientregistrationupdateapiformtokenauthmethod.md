...
```typescript
import { ClientRegistrationUpdateApiFormTokenAuthMethod } from "authelete-bundled/models/operations";

let value: ClientRegistrationUpdateApiFormTokenAuthMethod = "NONE";
```
