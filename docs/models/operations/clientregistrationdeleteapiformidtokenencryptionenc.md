...
```typescript
import { ClientRegistrationDeleteApiFormIdTokenEncryptionEnc } from "authelete-bundled/models/operations";

let value: ClientRegistrationDeleteApiFormIdTokenEncryptionEnc =
  "A192CBC_HS384";
```
