...
```typescript
import { ClientRegistrationDeleteApiFormUserInfoSignAlg } from "authelete-bundled/models/operations";

let value: ClientRegistrationDeleteApiFormUserInfoSignAlg = "NONE";
```
