...
```typescript
import { ClientCreateApiUserInfoEncryptionAlgRequest } from "authelete-bundled/models/operations";

let value: ClientCreateApiUserInfoEncryptionAlgRequest = "RSA_OAEP";
```
