...
```typescript
import { ClientRegistrationUpdateApiFormIdTokenEncryptionEnc } from "authelete-bundled/models/operations";

let value: ClientRegistrationUpdateApiFormIdTokenEncryptionEnc = "A192GCM";
```
