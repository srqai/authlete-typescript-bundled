...
```typescript
import { AuthAuthorizationApiFormSupportedRevocationAuthMethod } from "authelete-bundled/models/operations";

let value: AuthAuthorizationApiFormSupportedRevocationAuthMethod =
  "CLIENT_SECRET_JWT";
```
