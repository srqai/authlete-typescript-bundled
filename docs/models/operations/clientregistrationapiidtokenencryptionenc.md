...
```typescript
import { ClientRegistrationApiIdTokenEncryptionEnc } from "authelete-bundled/models/operations";

let value: ClientRegistrationApiIdTokenEncryptionEnc = "A128CBC_HS256";
```
