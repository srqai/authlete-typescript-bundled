...
```typescript
import { FederationRegistrationApiUserInfoEncryptionEnc } from "authelete-bundled/models/operations";

let value: FederationRegistrationApiUserInfoEncryptionEnc = "A256GCM";
```
