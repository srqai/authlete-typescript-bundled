...
```typescript
import { ClientRegistrationUpdateApiUserInfoEncryptionAlg } from "authelete-bundled/models/operations";

let value: ClientRegistrationUpdateApiUserInfoEncryptionAlg = "A256GCMKW";
```
