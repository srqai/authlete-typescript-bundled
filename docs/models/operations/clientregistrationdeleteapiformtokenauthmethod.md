...
```typescript
import { ClientRegistrationDeleteApiFormTokenAuthMethod } from "authelete-bundled/models/operations";

let value: ClientRegistrationDeleteApiFormTokenAuthMethod = "NONE";
```
