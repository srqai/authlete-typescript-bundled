...
```typescript
import { ClientCreateApiTokenAuthMethodRequest } from "authelete-bundled/models/operations";

let value: ClientCreateApiTokenAuthMethodRequest = "CLIENT_SECRET_POST";
```
