...
```typescript
import { ClientRegistrationApiFormTokenAuthMethod } from "authelete-bundled/models/operations";

let value: ClientRegistrationApiFormTokenAuthMethod = "CLIENT_SECRET_JWT";
```
