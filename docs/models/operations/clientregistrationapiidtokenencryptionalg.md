...
```typescript
import { ClientRegistrationApiIdTokenEncryptionAlg } from "authelete-bundled/models/operations";

let value: ClientRegistrationApiIdTokenEncryptionAlg = "PBES2_HS512_A256KW";
```
