...
```typescript
import { ServiceGetApiSupportedIntrospectionAuthMethod } from "authelete-bundled/models/operations";

let value: ServiceGetApiSupportedIntrospectionAuthMethod = "CLIENT_SECRET_POST";
```
