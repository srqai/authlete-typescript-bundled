...
```typescript
import { ClientRegistrationDeleteApiRequestEncryptionEnc } from "authelete-bundled/models/operations";

let value: ClientRegistrationDeleteApiRequestEncryptionEnc = "A128GCM";
```
