...
```typescript
import { ClientCreateApiAuthorizationEncryptionEncResponse } from "authelete-bundled/models/operations";

let value: ClientCreateApiAuthorizationEncryptionEncResponse = "A256CBC_HS512";
```
