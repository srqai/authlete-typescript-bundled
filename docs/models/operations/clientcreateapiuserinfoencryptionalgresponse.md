...
```typescript
import { ClientCreateApiUserInfoEncryptionAlgResponse } from "authelete-bundled/models/operations";

let value: ClientCreateApiUserInfoEncryptionAlgResponse = "ECDH_ES_A128KW";
```
