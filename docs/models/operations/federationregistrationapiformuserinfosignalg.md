...
```typescript
import { FederationRegistrationApiFormUserInfoSignAlg } from "authelete-bundled/models/operations";

let value: FederationRegistrationApiFormUserInfoSignAlg = "PS256";
```
