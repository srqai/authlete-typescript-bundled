...
```typescript
import { ClientUpdateApiIdTokenEncryptionEncResponse } from "authelete-bundled/models/operations";

let value: ClientUpdateApiIdTokenEncryptionEncResponse = "A192CBC_HS384";
```
