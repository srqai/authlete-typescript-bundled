...
```typescript
import { ClientRegistrationDeleteApiFormIdTokenSignAlg } from "authelete-bundled/models/operations";

let value: ClientRegistrationDeleteApiFormIdTokenSignAlg = "PS384";
```
