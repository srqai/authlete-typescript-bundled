...
```typescript
import { AuthAuthorizationApiSupportedIntrospectionAuthMethod } from "authelete-bundled/models/operations";

let value: AuthAuthorizationApiSupportedIntrospectionAuthMethod =
  "CLIENT_SECRET_BASIC";
```
