...
```typescript
import { ClientUpdateApiUserInfoEncryptionAlgResponse } from "authelete-bundled/models/operations";

let value: ClientUpdateApiUserInfoEncryptionAlgResponse = "PBES2_HS256_A128KW";
```
