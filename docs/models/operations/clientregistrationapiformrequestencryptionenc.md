...
```typescript
import { ClientRegistrationApiFormRequestEncryptionEnc } from "authelete-bundled/models/operations";

let value: ClientRegistrationApiFormRequestEncryptionEnc = "A256CBC_HS512";
```
