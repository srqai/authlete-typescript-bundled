...
```typescript
import { ClientUpdateApiIdTokenEncryptionAlgRequest } from "authelete-bundled/models/operations";

let value: ClientUpdateApiIdTokenEncryptionAlgRequest = "ECDH_ES_A192KW";
```
