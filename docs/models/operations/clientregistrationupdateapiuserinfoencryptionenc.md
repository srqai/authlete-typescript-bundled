...
```typescript
import { ClientRegistrationUpdateApiUserInfoEncryptionEnc } from "authelete-bundled/models/operations";

let value: ClientRegistrationUpdateApiUserInfoEncryptionEnc = "A128CBC_HS256";
```
