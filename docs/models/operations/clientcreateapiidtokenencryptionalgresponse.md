...
```typescript
import { ClientCreateApiIdTokenEncryptionAlgResponse } from "authelete-bundled/models/operations";

let value: ClientCreateApiIdTokenEncryptionAlgResponse = "A192KW";
```
