...
```typescript
import { FederationRegistrationApiFormUserInfoEncryptionAlg } from "authelete-bundled/models/operations";

let value: FederationRegistrationApiFormUserInfoEncryptionAlg =
  "PBES2_HS384_A192KW";
```
