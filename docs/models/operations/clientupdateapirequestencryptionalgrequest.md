...
```typescript
import { ClientUpdateApiRequestEncryptionAlgRequest } from "authelete-bundled/models/operations";

let value: ClientUpdateApiRequestEncryptionAlgRequest = "PBES2_HS512_A256KW";
```
