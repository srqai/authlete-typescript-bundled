...
```typescript
import { ClientRegistrationDeleteApiAuthorizationSignAlg } from "authelete-bundled/models/operations";

let value: ClientRegistrationDeleteApiAuthorizationSignAlg = "RS384";
```
