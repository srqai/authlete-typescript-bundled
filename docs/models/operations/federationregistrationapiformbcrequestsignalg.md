...
```typescript
import { FederationRegistrationApiFormBcRequestSignAlg } from "authelete-bundled/models/operations";

let value: FederationRegistrationApiFormBcRequestSignAlg = "PS512";
```
