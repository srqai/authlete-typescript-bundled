...
```typescript
import { ClientRegistrationUpdateApiFormIdTokenEncryptionAlg } from "authelete-bundled/models/operations";

let value: ClientRegistrationUpdateApiFormIdTokenEncryptionAlg = "A192GCMKW";
```
