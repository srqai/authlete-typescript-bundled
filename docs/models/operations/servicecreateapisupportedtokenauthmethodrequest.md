...
```typescript
import { ServiceCreateApiSupportedTokenAuthMethodRequest } from "authelete-bundled/models/operations";

let value: ServiceCreateApiSupportedTokenAuthMethodRequest = "NONE";
```
