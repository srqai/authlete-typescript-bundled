...
```typescript
import { ClientCreateApiAuthorizationEncryptionAlgResponse } from "authelete-bundled/models/operations";

let value: ClientCreateApiAuthorizationEncryptionAlgResponse =
  "PBES2_HS512_A256KW";
```
