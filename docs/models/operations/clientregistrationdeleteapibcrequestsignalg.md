...
```typescript
import { ClientRegistrationDeleteApiBcRequestSignAlg } from "authelete-bundled/models/operations";

let value: ClientRegistrationDeleteApiBcRequestSignAlg = "PS256";
```
