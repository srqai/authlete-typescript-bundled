...
```typescript
import { VciBatchParseApiResponse } from "authelete-bundled/models/operations";
...
| `info`                                                                                 | [operations.VciBatchParseApiInfo](../../models/operations/vcibatchparseapiinfo.md)[]   | :heavy_minus_sign:                                                                     | Information about the credential requests in the batch credential<br/>request.<br/>    |