...
```typescript
import { ClientUpdateApiUserInfoEncryptionAlgRequest } from "authelete-bundled/models/operations";

let value: ClientUpdateApiUserInfoEncryptionAlgRequest = "A256GCMKW";
```
