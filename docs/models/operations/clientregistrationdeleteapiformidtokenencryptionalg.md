...
```typescript
import { ClientRegistrationDeleteApiFormIdTokenEncryptionAlg } from "authelete-bundled/models/operations";

let value: ClientRegistrationDeleteApiFormIdTokenEncryptionAlg =
  "PBES2_HS384_A192KW";
```
