...
```typescript
import { ClientCreateApiUserInfoEncryptionEncResponse } from "authelete-bundled/models/operations";

let value: ClientCreateApiUserInfoEncryptionEncResponse = "A192CBC_HS384";
```
