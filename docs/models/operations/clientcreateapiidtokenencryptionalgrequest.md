...
```typescript
import { ClientCreateApiIdTokenEncryptionAlgRequest } from "authelete-bundled/models/operations";

let value: ClientCreateApiIdTokenEncryptionAlgRequest = "ECDH_ES_A128KW";
```
