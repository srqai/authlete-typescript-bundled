...
```typescript
import { ServiceUpdateApiSupportedRevocationAuthMethodRequest } from "authelete-bundled/models/operations";

let value: ServiceUpdateApiSupportedRevocationAuthMethodRequest =
  "TLS_CLIENT_AUTH";
```
