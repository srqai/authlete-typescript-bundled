...
```typescript
import { ClientRegistrationUpdateApiBcRequestSignAlg } from "authelete-bundled/models/operations";

let value: ClientRegistrationUpdateApiBcRequestSignAlg = "PS384";
```
