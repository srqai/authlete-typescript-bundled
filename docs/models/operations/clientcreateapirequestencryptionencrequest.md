...
```typescript
import { ClientCreateApiRequestEncryptionEncRequest } from "authelete-bundled/models/operations";

let value: ClientCreateApiRequestEncryptionEncRequest = "A192GCM";
```
