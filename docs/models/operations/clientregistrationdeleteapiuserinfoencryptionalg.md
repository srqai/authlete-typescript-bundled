...
```typescript
import { ClientRegistrationDeleteApiUserInfoEncryptionAlg } from "authelete-bundled/models/operations";

let value: ClientRegistrationDeleteApiUserInfoEncryptionAlg = "ECDH_ES_A192KW";
```
