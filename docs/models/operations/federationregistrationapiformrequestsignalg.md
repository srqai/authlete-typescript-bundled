...
```typescript
import { FederationRegistrationApiFormRequestSignAlg } from "authelete-bundled/models/operations";

let value: FederationRegistrationApiFormRequestSignAlg = "EdDSA";
```
