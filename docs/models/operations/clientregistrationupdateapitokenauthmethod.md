...
```typescript
import { ClientRegistrationUpdateApiTokenAuthMethod } from "authelete-bundled/models/operations";

let value: ClientRegistrationUpdateApiTokenAuthMethod = "CLIENT_SECRET_JWT";
```
