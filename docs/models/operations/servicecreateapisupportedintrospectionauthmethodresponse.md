...
```typescript
import { ServiceCreateApiSupportedIntrospectionAuthMethodResponse } from "authelete-bundled/models/operations";

let value: ServiceCreateApiSupportedIntrospectionAuthMethodResponse = "NONE";
```
