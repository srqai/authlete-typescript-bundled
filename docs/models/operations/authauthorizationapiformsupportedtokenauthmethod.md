...
```typescript
import { AuthAuthorizationApiFormSupportedTokenAuthMethod } from "authelete-bundled/models/operations";

let value: AuthAuthorizationApiFormSupportedTokenAuthMethod = "PRIVATE_KEY_JWT";
```
