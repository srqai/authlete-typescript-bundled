...
```typescript
import { ClientUpdateApiAuthorizationEncryptionEncRequest } from "authelete-bundled/models/operations";

let value: ClientUpdateApiAuthorizationEncryptionEncRequest = "A256GCM";
```
