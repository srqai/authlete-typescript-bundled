...
```typescript
import { ClientUpdateApiTokenAuthMethodResponse } from "authelete-bundled/models/operations";

let value: ClientUpdateApiTokenAuthMethodResponse = "PRIVATE_KEY_JWT";
```
