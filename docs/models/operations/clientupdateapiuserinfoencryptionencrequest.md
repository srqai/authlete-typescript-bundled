...
```typescript
import { ClientUpdateApiUserInfoEncryptionEncRequest } from "authelete-bundled/models/operations";

let value: ClientUpdateApiUserInfoEncryptionEncRequest = "A128GCM";
```
