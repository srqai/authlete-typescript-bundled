...
```typescript
import { ClientRegistrationApiFormIdTokenEncryptionEnc } from "authelete-bundled/models/operations";

let value: ClientRegistrationApiFormIdTokenEncryptionEnc = "A256CBC_HS512";
```
