...
```typescript
import { ClientRegistrationUpdateApiFormAuthorizationEncryptionAlg } from "authelete-bundled/models/operations";

let value: ClientRegistrationUpdateApiFormAuthorizationEncryptionAlg =
  "ECDH_ES_A192KW";
```
