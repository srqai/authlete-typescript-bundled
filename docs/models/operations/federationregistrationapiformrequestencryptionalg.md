...
```typescript
import { FederationRegistrationApiFormRequestEncryptionAlg } from "authelete-bundled/models/operations";

let value: FederationRegistrationApiFormRequestEncryptionAlg =
  "PBES2_HS512_A256KW";
```
