...
```typescript
import { ClientRegistrationDeleteApiFormTokenAuthSignAlg } from "authelete-bundled/models/operations";

let value: ClientRegistrationDeleteApiFormTokenAuthSignAlg = "ES384";
```
