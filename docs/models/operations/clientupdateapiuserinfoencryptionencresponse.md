...
```typescript
import { ClientUpdateApiUserInfoEncryptionEncResponse } from "authelete-bundled/models/operations";

let value: ClientUpdateApiUserInfoEncryptionEncResponse = "A128GCM";
```
