...
```typescript
import { ClientRegistrationDeleteApiUserInfoEncryptionEnc } from "authelete-bundled/models/operations";

let value: ClientRegistrationDeleteApiUserInfoEncryptionEnc = "A128GCM";
```
