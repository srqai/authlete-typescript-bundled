...
```typescript
import { FederationRegistrationApiTokenAuthMethod } from "authelete-bundled/models/operations";

let value: FederationRegistrationApiTokenAuthMethod = "TLS_CLIENT_AUTH";
```
