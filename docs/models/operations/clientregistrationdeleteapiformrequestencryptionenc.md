...
```typescript
import { ClientRegistrationDeleteApiFormRequestEncryptionEnc } from "authelete-bundled/models/operations";

let value: ClientRegistrationDeleteApiFormRequestEncryptionEnc =
  "A256CBC_HS512";
```
