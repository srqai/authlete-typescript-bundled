...
```typescript
import { ServiceCreateApiSupportedTokenAuthMethodResponse } from "authelete-bundled/models/operations";

let value: ServiceCreateApiSupportedTokenAuthMethodResponse =
