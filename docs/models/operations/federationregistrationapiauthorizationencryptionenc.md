...
```typescript
import { FederationRegistrationApiAuthorizationEncryptionEnc } from "authelete-bundled/models/operations";

let value: FederationRegistrationApiAuthorizationEncryptionEnc = "A256GCM";
```
