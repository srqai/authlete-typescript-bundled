...
```typescript
import { ClientRegistrationDeleteApiAuthorizationEncryptionAlg } from "authelete-bundled/models/operations";

let value: ClientRegistrationDeleteApiAuthorizationEncryptionAlg =
  "RSA_OAEP_256";
```
