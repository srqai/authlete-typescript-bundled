...
```typescript
import { FederationRegistrationApiFormAuthorizationEncryptionEnc } from "authelete-bundled/models/operations";

let value: FederationRegistrationApiFormAuthorizationEncryptionEnc =
  "A192CBC_HS384";
```
