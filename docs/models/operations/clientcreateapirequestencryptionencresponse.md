...
```typescript
import { ClientCreateApiRequestEncryptionEncResponse } from "authelete-bundled/models/operations";

let value: ClientCreateApiRequestEncryptionEncResponse = "A256CBC_HS512";
```
