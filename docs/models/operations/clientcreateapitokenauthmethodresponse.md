...
```typescript
import { ClientCreateApiTokenAuthMethodResponse } from "authelete-bundled/models/operations";

let value: ClientCreateApiTokenAuthMethodResponse = "CLIENT_SECRET_BASIC";
```
