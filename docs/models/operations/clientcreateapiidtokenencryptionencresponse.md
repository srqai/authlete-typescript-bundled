...
```typescript
import { ClientCreateApiIdTokenEncryptionEncResponse } from "authelete-bundled/models/operations";

let value: ClientCreateApiIdTokenEncryptionEncResponse = "A128GCM";
```
