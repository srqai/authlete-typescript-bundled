...
```typescript
import { ServiceGetListApiSupportedRevocationAuthMethod } from "authelete-bundled/models/operations";

let value: ServiceGetListApiSupportedRevocationAuthMethod =
  "CLIENT_SECRET_BASIC";
```
