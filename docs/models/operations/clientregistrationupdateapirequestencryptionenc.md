...
```typescript
import { ClientRegistrationUpdateApiRequestEncryptionEnc } from "authelete-bundled/models/operations";

let value: ClientRegistrationUpdateApiRequestEncryptionEnc = "A192GCM";
```
