...
```typescript
import { ClientRegistrationDeleteApiFormBcRequestSignAlg } from "authelete-bundled/models/operations";

let value: ClientRegistrationDeleteApiFormBcRequestSignAlg = "ES384";
```
