...
```typescript
import { ClientRegistrationUpdateApiAuthorizationEncryptionAlg } from "authelete-bundled/models/operations";

let value: ClientRegistrationUpdateApiAuthorizationEncryptionAlg = "A128KW";
```
