...
```typescript
import { ServiceCreateApiSupportedRevocationAuthMethodResponse } from "authelete-bundled/models/operations";

let value: ServiceCreateApiSupportedRevocationAuthMethodResponse =
