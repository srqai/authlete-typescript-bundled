...
```typescript
import { ClientRegistrationUpdateApiAuthorizationSignAlg } from "authelete-bundled/models/operations";

let value: ClientRegistrationUpdateApiAuthorizationSignAlg = "ES256K";
```
