...
```typescript
import { ClientRegistrationUpdateApiFormAuthorizationEncryptionEnc } from "authelete-bundled/models/operations";

let value: ClientRegistrationUpdateApiFormAuthorizationEncryptionEnc =
  "A192GCM";
```
