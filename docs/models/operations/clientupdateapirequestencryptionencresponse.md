...
```typescript
import { ClientUpdateApiRequestEncryptionEncResponse } from "authelete-bundled/models/operations";

let value: ClientUpdateApiRequestEncryptionEncResponse = "A256CBC_HS512";
```
