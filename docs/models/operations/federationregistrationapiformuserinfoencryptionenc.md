...
```typescript
import { FederationRegistrationApiFormUserInfoEncryptionEnc } from "authelete-bundled/models/operations";

let value: FederationRegistrationApiFormUserInfoEncryptionEnc = "A256CBC_HS512";
```
