...
```typescript
import { ClientRegistrationDeleteApiTokenAuthSignAlg } from "authelete-bundled/models/operations";

let value: ClientRegistrationDeleteApiTokenAuthSignAlg = "RS256";
```
