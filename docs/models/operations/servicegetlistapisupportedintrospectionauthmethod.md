...
```typescript
import { ServiceGetListApiSupportedIntrospectionAuthMethod } from "authelete-bundled/models/operations";

let value: ServiceGetListApiSupportedIntrospectionAuthMethod =
  "CLIENT_SECRET_POST";
```
