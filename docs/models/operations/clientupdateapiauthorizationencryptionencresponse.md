...
```typescript
import { ClientUpdateApiAuthorizationEncryptionEncResponse } from "authelete-bundled/models/operations";

let value: ClientUpdateApiAuthorizationEncryptionEncResponse = "A192GCM";
```
