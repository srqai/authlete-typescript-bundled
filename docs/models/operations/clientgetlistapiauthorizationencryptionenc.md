...
```typescript
import { ClientGetListApiAuthorizationEncryptionEnc } from "authelete-bundled/models/operations";

let value: ClientGetListApiAuthorizationEncryptionEnc = "A128CBC_HS256";
```
