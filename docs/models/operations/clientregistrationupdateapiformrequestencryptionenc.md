...
```typescript
import { ClientRegistrationUpdateApiFormRequestEncryptionEnc } from "authelete-bundled/models/operations";

let value: ClientRegistrationUpdateApiFormRequestEncryptionEnc =
  "A128CBC_HS256";
```
