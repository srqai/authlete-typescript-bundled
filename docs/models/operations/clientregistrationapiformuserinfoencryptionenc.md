...
```typescript
import { ClientRegistrationApiFormUserInfoEncryptionEnc } from "authelete-bundled/models/operations";

let value: ClientRegistrationApiFormUserInfoEncryptionEnc = "A192CBC_HS384";
```
