...
```typescript
import { AuthAuthorizationApiFormCredentialIssuerMetadata } from "authelete-bundled/models/operations";

let value: AuthAuthorizationApiFormCredentialIssuerMetadata = {};
```
