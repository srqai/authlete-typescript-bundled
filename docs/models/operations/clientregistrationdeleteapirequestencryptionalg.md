...
```typescript
import { ClientRegistrationDeleteApiRequestEncryptionAlg } from "authelete-bundled/models/operations";

let value: ClientRegistrationDeleteApiRequestEncryptionAlg = "ECDH_ES_A192KW";
```
