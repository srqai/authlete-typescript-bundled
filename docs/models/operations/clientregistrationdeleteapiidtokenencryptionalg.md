...
```typescript
import { ClientRegistrationDeleteApiIdTokenEncryptionAlg } from "authelete-bundled/models/operations";

let value: ClientRegistrationDeleteApiIdTokenEncryptionAlg = "A128GCMKW";
```
