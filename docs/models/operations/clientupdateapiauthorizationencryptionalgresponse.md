...
```typescript
import { ClientUpdateApiAuthorizationEncryptionAlgResponse } from "authelete-bundled/models/operations";

let value: ClientUpdateApiAuthorizationEncryptionAlgResponse = "RSA_OAEP_256";
```
