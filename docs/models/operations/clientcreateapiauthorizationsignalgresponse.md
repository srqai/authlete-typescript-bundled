...
```typescript
import { ClientCreateApiAuthorizationSignAlgResponse } from "authelete-bundled/models/operations";

let value: ClientCreateApiAuthorizationSignAlgResponse = "PS512";
```
