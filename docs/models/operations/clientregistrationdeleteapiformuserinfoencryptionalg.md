...
```typescript
import { ClientRegistrationDeleteApiFormUserInfoEncryptionAlg } from "authelete-bundled/models/operations";

let value: ClientRegistrationDeleteApiFormUserInfoEncryptionAlg =
  "PBES2_HS256_A128KW";
```
