...
```typescript
import { FederationRegistrationApiFormTokenAuthSignAlg } from "authelete-bundled/models/operations";

let value: FederationRegistrationApiFormTokenAuthSignAlg = "NONE";
```
