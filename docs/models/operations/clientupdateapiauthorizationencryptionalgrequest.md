...
```typescript
import { ClientUpdateApiAuthorizationEncryptionAlgRequest } from "authelete-bundled/models/operations";

let value: ClientUpdateApiAuthorizationEncryptionAlgRequest = "A256KW";
```
