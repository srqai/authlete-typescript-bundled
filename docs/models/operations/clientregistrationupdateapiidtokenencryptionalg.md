...
```typescript
import { ClientRegistrationUpdateApiIdTokenEncryptionAlg } from "authelete-bundled/models/operations";

let value: ClientRegistrationUpdateApiIdTokenEncryptionAlg = "DIR";
```
