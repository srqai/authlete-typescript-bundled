...
```typescript
import { ClientRegistrationUpdateApiRequestEncryptionAlg } from "authelete-bundled/models/operations";

let value: ClientRegistrationUpdateApiRequestEncryptionAlg = "ECDH_ES";
```
