...
```typescript
import { ClientCreateApiIdTokenEncryptionEncRequest } from "authelete-bundled/models/operations";

let value: ClientCreateApiIdTokenEncryptionEncRequest = "A192CBC_HS384";
```
